...
describe("test contract", () => {
    ...
    it("should compute contract address", async () => {
        ...
        assert.equal(firstContractAddress.toBech32(), "drt1qqqqqqqqqqqqqpgqhdjjyq8dr7v5yq9tv6v5vt9tfvd00vg7h40q8zfxpd");

        let secondContractAddress = SmartContract.computeAddress(owner, 1n);
        assert.equal(
            secondContractAddress.toBech32(),
            "drt1qqqqqqqqqqqqqpgqde8eqjywyu6zlxjxuxqfg5kgtmn3setxh40qy0s6t6",
        );
    });
    ...
    it("should deploy", async () => {
        ...
        assert.equal(
            ...
            "drt1qqqqqqqqqqqqqpgq2xx50huxl6zpzqplsszsxmd5cd88vagkh5jqg0yfn2",
        );
    ...
    it("should upgrade", async () => {
        ...
        let contract = new SmartContract();
        contract.setAddress(Address.newFromBech32("drt1qqqqqqqqqqqqqpgq2xx50huxl6zpzqplsszsxmd5cd88vagkh5jqg0yfn2"));
    ...
    it("v13 should be stricter than v12 on optional<variadic<type>> (exotic) parameters (since NativeSerializer is used under the hood)", async () => {
        ...
        const callerAddress = Address.newFromBech32("drt1c7pyyq2yaq5k7atn9z6qn5qkxwlc6zwc4vg7uuxn9ssy7evfh5jq4nm79l");
