...
export const rawUpdateGlobalAmountsEvent = new RawEvent({
    address: 'drt1qqqqqqqqqqqqqpgqur83hqn9j4y6v93m09nn2q0yazuhk2rvpr9sql4h8v',
...
export const rawClaimMultiEventWithRewards = new RawEvent({
    ...
    data: 'AAAADFdSRVdBLWQ3YzZiYgAAAAAAAAAAAAAABwL0aurSihsAAAANUFJPVEVPLWQxZWYzOQAAAAAAAAAAAAAABoULpFuu7wAAAA1EU1VQRVItOWFmOGRmAAAAAAAAAAAAAAAIAfOB+ea/fgM=',
});
