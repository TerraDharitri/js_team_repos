...
export class WalletConnectV2Provider {
  ...
  address: string = "";
  signature: string = "";
  namespace: string = WALLETCONNECT_DHARITRI_NAMESPACE;
  ...
  reset() {
    this.address = "";
    this.signature = "";
    this.namespace = WALLETCONNECT_DHARITRI_NAMESPACE;
  ...
  private getConnectionParams(
    ...
    const chains = [`${WALLETCONNECT_DHARITRI_NAMESPACE}:${this.chainId}`];
