...
import { WALLETCONNECT_DHARITRI_CHAIN_ID } from "./constants";
...
export class WalletConnectProvider {
    ...
    async login(): Promise<string> {
        ...
        await this.walletConnector?.createSession({ chainId: WALLETCONNECT_DHARITRI_CHAIN_ID });
