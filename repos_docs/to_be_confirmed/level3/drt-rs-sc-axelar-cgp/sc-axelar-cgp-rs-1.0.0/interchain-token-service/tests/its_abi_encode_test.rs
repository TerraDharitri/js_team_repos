use dharitri_sc::hex_literal::hex;
use dharitri_sc::types::{BigUint, ManagedBuffer, ManagedByteArray};
...
fn encode_send_to_hub_payload() {
    ...
    let data = SendToHubPayload::<StaticApi> {
