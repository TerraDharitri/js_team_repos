...
test('Pay gas for contract call no dcdts', async () => {
  ...
  }).assertFail({ code: 4, message: 'incorrect number of DCDT transfers' });
...
test('Pay gas for express contract call no dcdts', async () => {
  await deployContract();
...
test('Add express gas no dcdts', async () => {
  await deployContract();
