...
test('Approve messages with multisig prover encoded data', async () => {
  const message = e.Tuple(
    ...
    e.Addr('drt1qqqqqqqqqqqqqpgqd77fnev2sthnczp2lnfx0y5jdycynjfhzzgq8axq7c'),
  ...
  // 000000000000000005006fbc99e58a82ef3c082afcd2679292693049c9371090 - destination address `drt1qqqqqqqqqqqqqpgqd77fnev2sthnczp2lnfx0y5jdycynjfhzzgq8axq7c` from bech32 to hex
