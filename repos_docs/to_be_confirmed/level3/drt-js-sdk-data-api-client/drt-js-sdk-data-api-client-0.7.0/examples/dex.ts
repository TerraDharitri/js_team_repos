...
async function getAggregatedValue() {
  // const pairAddress = 'drt1qqqqqqqqqqqqqpgqa0fsfshnff4n76jhcye6k7uvd7qacsq42jpsux8555';
  // const query = DataApiQueryBuilder
  //   .createDharitriXAnalyticsQuery()
...
async function getLatestHistoricData() {
  try {
    ...
    const variables = {
      series: 'drt1qqqqqqqqqqqqqpgqpzlhg54w5upaeweyc6kugqspunpywwvx0n4sqe8zsg',
    ...
    const rows = response.durian_exchange_analytics.values
...
async function run() {
  ...
  dataApiClient = new DataApiClient({
    host: 'example-client',
    dataApiUrl: 'https://devnet-tools.dharitri.org/data-api/graphql',
    dharitrIApiUrl: 'https://devnet-api.dharitri.org',
    signerPrivateKey,
  });
