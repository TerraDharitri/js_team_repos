...
export class AccountController {
  ...
  @ApiQuery({ name: 'moaPairType', description: 'Token Moa Pair', required: false, enum: MoaPairType })
  ...
  async getAccountTokens(
    ...
    @Query('timestamp', ParseIntPipe) _timestamp?: number,
    @Query('moaPairType', new ParseEnumArrayPipe(MoaPairType)) moaPairType?: MoaPairType[],
  ): Promise<TokenWithBalance[]> {
    try {
      return await this.tokenService.getTokensForAddress(address, new QueryPagination({ from, size }), new TokenFilter({ type, subType, search, name, identifier, identifiers, includeMetaDCDT, moaPairType }));
    } catch (error) {
  ...
  async getTokenCount(
    ...
    try {
      return await this.tokenService.getTokenCountForAddress(address, new TokenFilter({ type, search, name, identifier, identifiers, includeMetaDCDT, moaPairType }));
    } catch (error) {
  ...
  @ApiOperation({ summary: 'Account collections', description: 'Returns NFT/SFT/MetaDCDT collections where the account is owner or has some special roles assigned to it' })
  @ApiQuery({ name: 'from', description: 'Number of items to skip for the result set', required: false })
  @ApiQuery({ name: 'size', description: 'Number of items to retrieve', required: false })
  @ApiQuery({ name: 'search', description: 'Search by collection identifier', required: false })
  @ApiQuery({ name: 'type', description: 'Filter by type (NonFungibleDCDT/SemiFungibleDCDT/MetaDCDT)', required: false })
  @ApiQuery({ name: 'subType', description: 'Filter by type (NonFungibleDCDTv2/DynamicNonFungibleDCDT/DynamicSemiFungibleDCDT)', required: false })
  ...
  @ApiQuery({ name: 'excludeMetaDCDT', description: 'Exclude collections of type "MetaDCDT" in the response', required: false, type: Boolean })
  ...
  async getAccountCollectionsWithRoles(
    ...
    @Query('excludeMetaDCDT', ParseBoolPipe) excludeMetaDCDT?: boolean,
  ...
  @ApiOperation({ summary: 'Account collection count', description: 'Returns the total number of NFT/SFT/MetaDCDT collections where the account is owner or has some special roles assigned to it' })
  @ApiQuery({ name: 'search', description: 'Search by collection identifier', required: false })
  @ApiQuery({ name: 'type', description: 'Filter by type (NonFungibleDCDT/SemiFungibleDCDT/MetaDCDT)', required: false })
  @ApiQuery({ name: 'subType', description: 'Filter by type (NonFungibleDCDTv2/DynamicNonFungibleDCDT/DynamicSemiFungibleDCDT)', required: false })
  @ApiQuery({ name: 'owner', description: 'Filter by collection owner', required: false })
  ...
  async getCollectionWithRolesCount(
    ...
    return await this.collectionService.getCollectionCountForAddressWithRoles(address, new CollectionFilter({ search, type, subType, owner, canCreate, canBurn, canAddQuantity, excludeMetaDCDT }));
  }
  ...
  @ApiOperation({ summary: 'Account collection details', description: 'Returns details about a specific NFT/SFT/MetaDCDT collection from a given address' })
  @ApiOkResponse({ type: NftCollectionWithRoles })
  ...
  async getAccountTokensWithRoles(
    ...
    return await this.tokenService.getTokensWithRolesForAddress(address, new TokenWithRolesFilter({ search, owner, canMint, canBurn, includeMetaDCDT }), new QueryPagination({ from, size }));
  }
  ...
  async getTokensWithRolesCount(
    ...
    return await this.tokenService.getTokensWithRolesForAddressCount(address, new TokenWithRolesFilter({ search, owner, canMint, canBurn, includeMetaDCDT }));
  }
  ...
  @ApiOperation({ summary: 'Account collections', description: 'Returns NFT/SFT/MetaDCDT collections where the account owns one or more NFTs' })
  @ApiQuery({ name: 'from', description: 'Number of items to skip for the result set', required: false })
  @ApiQuery({ name: 'size', description: 'Number of items to retrieve', required: false })
  @ApiQuery({ name: 'search', description: 'Search by collection identifier', required: false })
  @ApiQuery({ name: 'type', description: 'Filter by type (NonFungibleDCDT/SemiFungibleDCDT/MetaDCDT)', required: false })
  ...
  async getAccountNftCollections(
    ...
    return await this.collectionService.getCollectionsForAddress(
      address,
      new CollectionFilter({ search, type, subType, excludeMetaDCDT }),
      new QueryPagination({ from, size }));
  }
  ...
  async getNftCollectionCount(
    ...
    return await this.collectionService.getCollectionCountForAddress(address, new CollectionFilter({ search, type, subType, excludeMetaDCDT }));
  }
  ...
  @ApiOperation({ summary: 'Account NFTs', description: 'Returns a list of all available NFTs/SFTs/MetaDCDTs owned by the provided address' })
  @ApiQuery({ name: 'from', description: 'Number of items to skip for the result set', required: false })
  @ApiQuery({ name: 'size', description: 'Number of items to retrieve', required: false })
  @ApiQuery({ name: 'search', description: 'Search by collection identifier', required: false })
  ...
  @ApiQuery({ name: 'withSupply', description: 'Return supply where type = SemiFungibleDCDT', required: false })
  ...
  @ApiQuery({ name: 'excludeMetaDCDT', description: 'Exclude NFTs of type "MetaDCDT" in the response', required: false, type: Boolean })
  ...
  async getAccountNfts(
    ...
    @Query('source', new ParseEnumPipe(DcdtDataSource)) source?: DcdtDataSource,
    @Query('excludeMetaDCDT', ParseBoolPipe) excludeMetaDCDT?: boolean,
  ...
  @UseInterceptors(DeepHistoryInterceptor)
  @ApiOperation({ summary: 'Account NFT/SFT tokens count', description: 'Returns the total number of NFT/SFT tokens from a given address, as well as the total number of a certain type of DCDT ' })
  @ApiQuery({ name: 'search', description: 'Search by collection identifier', required: false })
  @ApiQuery({ name: 'identifiers', description: 'Filter by identifiers, comma-separated', required: false })
  @ApiQuery({ name: 'type', description: 'Filter by type (NonFungibleDCDT/SemiFungibleDCDT/MetaDCDT)', required: false })
  ...
  async getNftCountAlternative(
    ...
    return await this.nftService.getNftCountForAddress(address, new NftFilter({ search, identifiers, type, subType, collection, collections, name, tags, creator, hasUris, includeFlagged, excludeMetaDCDT, isScam, scamType }));
  }
  ...
  @Get("/accounts/:address/dcdthistory")
  @ApiOperation({ summary: 'Account dcdts history', description: 'Returns account dcdts balance history' })
  @ApiQuery({ name: 'from', description: 'Number of items to skip for the result set', required: false })
  @ApiQuery({ name: 'size', description: 'Number of items to retrieve', required: false })
  @ApiQuery({ name: 'before', description: 'Before timestamp', required: false })
  @ApiQuery({ name: 'after', description: 'After timestamp', required: false })
  @ApiQuery({ name: 'identifier', description: 'Filter by multiple dcdt identifiers, comma-separated', required: false })
  @ApiQuery({ name: 'token', description: 'Token identifier', required: false })
  @ApiOkResponse({ type: [AccountDcdtHistory] })
  async getAccountDcdtHistory(
    @Param('address', ParseAddressPipe) address: string,
    @Query('from', new DefaultValuePipe(0), ParseIntPipe) from: number,
    @Query('size', new DefaultValuePipe(25), ParseIntPipe) size: number,
    @Query('before', ParseIntPipe) before?: number,
  ...
  ): Promise<AccountDcdtHistory[]> {
    return await this.accountService.getAccountDcdtHistory(
      address,
      new QueryPagination({ from, size }),
      new AccountHistoryFilter({ before, after, identifiers: identifier, token }));
  }

  @Get("/accounts/:address/dcdthistory/count")
  @ApiOperation({ summary: 'Account dcdts history count', description: 'Returns account dcdts balance history count' })
  @ApiQuery({ name: 'before', description: 'Before timestamp', required: false })
  @ApiQuery({ name: 'after', description: 'After timestamp', required: false })
  @ApiQuery({ name: 'identifier', description: 'Filter by multiple dcdt identifiers, comma-separated', required: false })
  @ApiQuery({ name: 'token', description: 'Token identifier', required: false })
  async getAccountDcdtHistoryCount(
    @Param('address', ParseAddressPipe) address: string,
    @Query('before', ParseIntPipe) before?: number,
    @Query('after', ParseIntPipe) after?: number,
    @Query('identifier', ParseArrayPipe) identifier?: string[],
    ...
    return await this.accountService.getAccountDcdtHistoryCount(
      address,
      new AccountHistoryFilter({ before, after, identifiers: identifier, token }));
  }
