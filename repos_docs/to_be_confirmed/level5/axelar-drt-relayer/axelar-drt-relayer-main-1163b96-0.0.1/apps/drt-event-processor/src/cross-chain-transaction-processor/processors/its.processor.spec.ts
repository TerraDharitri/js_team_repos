...
const mockItsContract = 'drt1yvesqqqqqqqqqqqqqqqqqqqqqqqqyvesqqqqqqqqqqqqqqqplllsphc9lf';
...
describe('ItsProcessor', () => {
  ...
  describe('Handle interchain transfer event', () => {
    ...
    const interchainTransferEvent: InterchainTransferEvent = {
      tokenId: '0c38359b7a35c755573659d797afec315bb0e51374a056745abd9764715a15da',
      sourceAddress: Address.newFromBech32('drt1qqqqqqqqqqqqqpgqzqvm5ywqqf524efwrhr039tjs29w0qltkklsqnrz4q'),
    ...
    it('Should handle', () => {
      ...
      expect(event.sourceAddress).toBe('drt1qqqqqqqqqqqqqpgqzqvm5ywqqf524efwrhr039tjs29w0qltkklsqnrz4q');
