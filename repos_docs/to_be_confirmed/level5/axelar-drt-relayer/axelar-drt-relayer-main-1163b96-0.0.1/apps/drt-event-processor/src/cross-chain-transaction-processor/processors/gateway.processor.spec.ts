...
describe('GatewayProcessor', () => {
  ...
  const messageApprovedEvent: MessageApprovedEvent = {
    ...
    contractAddress: Address.fromBech32('drt1qqqqqqqqqqqqqpgqzqvm5ywqqf524efwrhr039tjs29w0qltkklsqnrz4q'),
    payloadHash: 'ebc84cbd75ba5516bf45e7024a9e12bc3c5c880f73e3a5beca7ebba52b2867a7',
  };
  ...
  describe('handleContractCallEvent', () => {
    ...
    it('Should handle event', async () => {
      ...
      expect(event.message.sourceChain).toBe('dharitri');
  ...
  describe('handleMessageApprovedEvent', () => {
    const rawEvent: TransactionEvent = TransactionEvent.fromHttpResponse({
      ...
      topics: [
        ...
        Buffer.from(
          Address.fromBech32('drt1qqqqqqqqqqqqqpgqzqvm5ywqqf524efwrhr039tjs29w0qltkklsqnrz4q').hex(),
          'hex',
        ).toString('base64'),
    ...
    it('Should handle event', async () => {
      ...
      const transaction = createMock<TransactionOnNetwork>();
      transaction.hash = 'txHash';
      transaction.sender = Address.newFromBech32('drt1qqqqqqqqqqqqqpgqzqvm5ywqqf524efwrhr039tjs29w0qltkklsqnrz4q');
      ...
      expect(event.message.destinationAddress).toBe('drt1qqqqqqqqqqqqqpgqzqvm5ywqqf524efwrhr039tjs29w0qltkklsqnrz4q');
      expect(event.message.payloadHash).toBe(BinaryUtils.hexToBase64(contractCallEvent.payloadHash));
