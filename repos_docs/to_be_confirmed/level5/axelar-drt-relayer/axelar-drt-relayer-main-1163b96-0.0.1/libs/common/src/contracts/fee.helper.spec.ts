...
describe('FeeHelper', () => {
  ...
  describe('checkGasCost', () => {
    it('Enough gas fee', () => {
      try {
        ...
        feeHelper.checkGasCost(10_000_000, 0, TransactionPayload.fromEncoded('test'), {
          availableGasBalance: '300000000000000', // 0.00003 REWA
    ...
    it('Not enough gas fee', () => {
      try {
        // @ts-ignore
        feeHelper.checkGasCost(10_000_000, 0, TransactionPayload.fromEncoded('test'), {
          availableGasBalance: '100000000000000', // 0.00001 REWA
          sourceChain: 'ethereum',
          messageId: 'messageId',
        });
  ...
  it('getGasLimitFromRewaFee', () => {
    expect(
      feeHelper.getGasLimitFromRewaFee(
  ...
  it('getRewaFeeFromGasLimit', () => {
    expect(
      feeHelper.getRewaFeeFromGasLimit(
        BigInt(8243661),
        BigInt(321)
      ),
