...
describe('getSmartDecodedParts', () => {
  ...
  it('should decode parts[2] when first part is DCDTNFTTransfer', () => {
    const mockDecodedValue = '123';
    (decodeByMethod as jest.Mock).mockReturnValue(mockDecodedValue);

    const input = {
      parts: [TransactionTypesEnum.DCDTNFTTransfer, 'value1', 'hexValue'],
  ...
  it('should decode parts[1] when identifier is DCDTNFTTransfer', () => {
    ...
    const input = {
      ...
      identifier: TransactionTypesEnum.DCDTNFTTransfer
    };
  ...
  it('should handle both conditions simultaneously', () => {
    ...
    const input = {
      parts: [TransactionTypesEnum.DCDTNFTTransfer, base64Value, 'hexValue'],
      decodedParts: ['decoded1', 'decoded2', 'decoded3'],
      identifier: TransactionTypesEnum.DCDTNFTTransfer
    };
