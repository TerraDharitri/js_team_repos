...
describe('getTokenFromData tests', () => {
  test('get nft test', () => {
    const result = getTokenFromData(
      'DCDTNFTTransfer@4d455441524944452d346264313933@4022@a688906bd8b00000@ebfd923cd251f857ed7639e87143ac83f12f423827abc4a0cdde0119c3e37915'
    );
  ...
  test('get multidcdt test', () => {
    const result = getTokenFromData(
      'MultiDCDTNFTTransfer@00000000000000000500bfa6f00d36d61f232c3c7532fae6b08e3909aac27ceb@02@57524557412d383836303061@@4657679aa5be59@4d4f412d623662623764@@e5eb0b83150fb8ec2b@6164644c6971756964697479@45a354a5e6a567@e39e745b5f173ec0d8'
    );
  ...
  test('get nft from burn transaction', () => {
    const result = getTokenFromData(
      'DCDTNFTBurn@4554484f532d643735383863@015a@01'
    );
