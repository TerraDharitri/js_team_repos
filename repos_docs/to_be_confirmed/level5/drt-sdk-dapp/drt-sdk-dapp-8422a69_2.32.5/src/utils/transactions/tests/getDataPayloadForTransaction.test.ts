...
describe('getDataPayloadForTransaction', () => {
  ...
  it('should return the data unmodified when DCDT data is provided', async () => {
    const data =
      'DCDTNFTTransfer@524f424f54532d316365303334@01@01@0000000000000000050006bdc61ebbec719b07b4a7ebfd1fb215c0706e3c7ceb';
    const result = getDataPayloadForTransaction(data);
    expect(result.toString()).toStrictEqual(data);
  });
