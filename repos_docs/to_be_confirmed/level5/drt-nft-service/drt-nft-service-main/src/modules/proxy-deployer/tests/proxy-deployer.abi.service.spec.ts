...
describe('Proxy  Deployer Abi Service', () => {
  ...
  describe('deployMarketplaceSc', () => {
    it('returns built transaction with right arguments', async () => {
      ...
      const expectedResult = {
        chainID: 'T',
        data: 'Y29udHJhY3REZXBsb3lAMDAwMDAwMDAwMDAwMDAwMDA1MDAyZjcwNTEzMzE1ZTIwNDM0MDNhMDkwMTEyNmRkODYzMmNkZTc3MTU5ZTNkZkAwM2U4QDU3NTI0NTU3NDEyZDYxMzIzODYzMzUzOQ==',
        gasLimit: 70000000,
        gasPrice: 1000000000,
        nonce: 0,
        options: undefined,
  ...
  it('returns built transaction with right arguments including paymentTokens', async () => {
    ...
    const expectedResult = {
      chainID: 'T',
      data: 'Y29udHJhY3REZXBsb3lAMDAwMDAwMDAwMDAwMDAwMDA1MDAyZjcwNTEzMzE1ZTIwNDM0MDNhMDkwMTEyNmRkODYzMmNkZTc3MTU5ZTNkZkAyNzEwQDUyNDU1NzQx',
      gasLimit: 70000000,
      gasPrice: 1000000000,
      nonce: 0,
      options: undefined,
