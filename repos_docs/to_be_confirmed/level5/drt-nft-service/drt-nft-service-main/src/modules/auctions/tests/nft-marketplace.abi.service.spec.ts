...
import { DrtApiService, DrtProxyService } from 'src/common';
...
describe('Nft Marketplace Abi Service', () => {
  ...
  describe('createAuction', () => {
    ...
    const expectedResult = {
      chainID: 'T',
      data: 'RENEVE5GVFRyYW5zZmVyQDQ3NDU0ZTJkMzgzOTM4MzQ2NTM3QDA3QDAxQDAwMDAwMDAwMDAwMDAwMDAwNTAwZTJmNWZlZWM0NTZjZWE3NzkxNzIzZTM3ODczMDhkYzcyM2Y5NTI5OTBmZDZANjE3NTYzNzQ2OTZmNmU1NDZmNmI2NTZlQDNiOWFjYTAwQGE5OGFjN0BiYzYxMzZANTI0NTU3NDFAMjM4NmYyNmZjMTAwMDA=',
      gasLimit: 18000000,
      gasPrice: 1000000000,
      nonce: 0,
      options: undefined,
    ...
    it('with accepted payment identifier returns built transaction with right arguments', async () => {
      ...
      const expectedResult = {
        chainID: 'T',
        data: 'RENEVE5GVFRyYW5zZmVyQDQ3NDU0ZTJkMzgzOTM4MzQ2NTM3QDA3QDAxQDAwMDAwMDAwMDAwMDAwMDAwNTAwZTJmNWZlZWM0NTZjZWE3NzkxNzIzZTM3ODczMDhkYzcyM2Y5NTI5OTBmZDZANjE3NTYzNzQ2OTZmNmU1NDZmNmI2NTZlQDNiOWFjYTAwQGE5OGFjN0BiYzYxMzZANDQ0MzQ0NTRAMjM4NmYyNmZjMTAwMDA=',
        gasLimit: 18000000,
        gasPrice: 1000000000,
        nonce: 0,
        options: undefined,
  ...
  describe('bid', () => {
    ...
    it('bid with DCDT payment token returns built transaction with right arguments', async () => {
      ...
      const expectedResult = {
        chainID: 'T',
        data: 'RENEVFRyYW5zZmVyQDQ0NDM0NDU0QDY1MGUxMjRlZjFjN0A2MjY5NjRAMDFANDc0NTRlMmQzODM5MzgzNDY1MzdAMDc=',
        gasLimit: 11100000,
        gasPrice: 1000000000,
        nonce: 0,
        options: undefined,
  ...
  describe('createOffer', () => {
    ...
    it('with DCDT payment token returns built transaction with right arguments', async () => {
      ...
      const expectedResult = {
        chainID: 'T',
        data: 'RENEVFRyYW5zZmVyQDQ0NDM0NDU0QDY1MGUxMjRlZjFjN0A3MzY1NmU2NDRmNjY2NjY1NzJANDc0NTRlMmQzODM5MzgzNDY1MzdAMDdAMDFAMDEwMmIzNjIxMWM3QDAx',
        gasLimit: 11100000,
        gasPrice: 1000000000,
        nonce: 0,
        options: undefined,
  ...
  describe('acceptOffer', () => {
    ...
    it('without active auction returns built transaction with right arguments', async () => {
      ...
      const expectedResult = {
        chainID: 'T',
        data: 'RENEVE5GVFRyYW5zZmVyQDQ3NDU0ZTJkMzgzOTM4MzQ2NTM3QDAxQDAyQDAwMDAwMDAwMDAwMDAwMDAwNTAwZTJmNWZlZWM0NTZjZWE3NzkxNzIzZTM3ODczMDhkYzcyM2Y5NTI5OTBmZDZANjE2MzYzNjU3MDc0NGY2NjY2NjU3MkAwMQ==',
        gasLimit: 10100000,
        gasPrice: 1000000000,
        nonce: 0,
        options: undefined,
    ...
    it('with active auction but not owner throws expected error', async () => {
      ...
      const result = service.acceptOffer('drt1dc3yzxxeq69wvf583gw0h67td226gu2ahpk3k50qdgzzym8npltq7ndghb', acceptOfferWithAuctionId);
      await expect(result).rejects.toThrowError(new BadRequestError('No offer/auction available'));
    });
  ...
  describe('buySft', () => {
    ...
    it('with DCDT payment token returns built transaction with right arguments', async () => {
      ...
      const expectedResult = {
        chainID: 'T',
        data: 'RENEVFRyYW5zZmVyQDQ0NDM0NDU0QDEwZjQ0N0A2Mjc1Nzk1MzY2NzRAMDFANDc0NTRlMmQzODM5MzgzNDY1MzdAMDFAMDE=',
        gasLimit: 13000000,
        gasPrice: 1000000000,
        nonce: 0,
        options: undefined,
