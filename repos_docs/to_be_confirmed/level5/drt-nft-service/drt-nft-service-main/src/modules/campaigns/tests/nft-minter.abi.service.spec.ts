...
describe('Nft Minter Abi Service', () => {
    ...
    it('returns build transaction with right arguments', async () => {
      const result = await service.issueToken(
        new IssueCampaignRequest({
          ...
          minterAddress: 'drt1dc3yzxxeq69wvf583gw0h67td226gu2ahpk3k50qdgzzym8npltqr06t5r',
      ...
      const expectedResult = {
        chainID: 'T',
        data: 'aXNzdWVUb2tlbkZvckJyYW5kQDY4NjE3MzY4QDYzNjE2ZDcwNjE2OTY3NmU0OTY0QDcwNmU2N0AwM2U4QGJjMGQ4OEAwNzM5ODk0Y0A1MjQ1NTc0MUA0ZTYxNmQ2NUA0ZTQxNGQ0NUBiOGY0N2NAMDAwMDAwMDM3NDYxNjdANzQ2OTY1NzI0ZTYxNmQ2NUA2NEAwNWY1ZTEwMA==',
        gasLimit: 70000000,
        gasPrice: 1000000000,
        nonce: 0,
        options: undefined,
  ...
  describe('buyRandomNft', () => {
    it('returns build transaction with right arguments', async () => {
      const expectedResult = {
        ...
        nonce: 0,
        options: undefined,
        receiver: 'drt1qqqqqqqqqqqqqpgq7t389h9twftwlnt29hm0xz58v7k3vt6fpltq2h3sqz',
        sender: 'drt1dc3yzxxeq69wvf583gw0h67td226gu2ahpk3k50qdgzzym8npltqr06t5r',
        signature: undefined,
        value: '10000000',
        version: 2,
      ...
      const result = await service.buyRandomNft(
        ...
        new BuyRequest({
          campaignId: 'campaign',
          tier: 'tier',
          minterAddress: 'drt1qqqqqqqqqqqqqpgq7t389h9twftwlnt29hm0xz58v7k3vt6fpltq2h3sqz',
          price: '10000000',
          quantity: '12',
        }),
      );
  ...
  describe('upgradeNft', () => {
    it('returns build transaction with right arguments', async () => {
      ...
      const expectedResult = {
        chainID: 'T',
        data: 'RENEVE5GVFRyYW5zZmVyQDQzNDE0ZDUwMmQzMzYyNjQzMTYzMzdAMDFAMDFAMDAwMDAwMDAwMDAwMDAwMDA1MDBmMmUyNzJkY2FiNzI1NmVmY2Q2YTJkZjZmMzBhODc2N2FkMTYyZjQ5MGZkNkA2ZTY2NzQ1NTcwNjc3MjYxNjQ2NUA2MzYxNmQ3MDYxNjk2NzZlNDk2NA==',
        gasLimit: 13000000,
        gasPrice: 1000000000,
        nonce: 0,
        options: undefined,
