import { Token } from "@drt-monorepo/common";
...
export class Asset {
  ...
  static fromToken(token: Token, extra: { wrewaIdentifier: string, usdcIdentifier: string }): Asset {
    ...
    if (token.identifier === extra.wrewaIdentifier) {
      // name = ' eGold';
      symbol = 'REWA';
    }
