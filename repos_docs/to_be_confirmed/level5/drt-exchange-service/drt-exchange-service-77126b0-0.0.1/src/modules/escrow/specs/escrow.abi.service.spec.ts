...
import { DRTGatewayServiceProvider } from 'src/services/dharitri-communication/drt.gateway.service.mock';
import { SCPermissions } from '../models/escrow.model';
import { DRTGatewayService } from 'src/services/dharitri-communication/drt.gateway.service';
...
describe('EscrowAbiService', () => {
    ...
    let drtGateway: DRTGatewayService;
    ...
    beforeAll(async () => {
        ...
        drtGateway = module.get<DRTGatewayService>(DRTGatewayService);
