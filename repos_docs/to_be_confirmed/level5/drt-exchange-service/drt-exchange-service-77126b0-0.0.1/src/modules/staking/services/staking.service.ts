...
export class StakingService {
    ...
    async getFarmingToken(stakeAddress: string): Promise<DcdtToken> {
    ...
    async getAllFarmingTokens(stakeAddresses: string[]): Promise<DcdtToken[]> {
    ...
    async getRewardToken(stakeAddress: string): Promise<DcdtToken> {
