...
export class DRTProxyService {
    ...
    constructor(
        ...
        this.proxy = new ProxyNetworkProviderProfiler(
            ...
            this.apiConfigService.getGatewayUrl(),
            {
                ...
                headers: {
                    origin: 'DharitriXService',
                },
                clientName: 'DharitriXService',
            },
        );

        DRTProxyService.smartContracts = [];
        DRTProxyService.smartContractTransactionFactories = [];
    }
    ...
    private async createSmartContractTransactionsFactory(
        ...
        DRTProxyService.smartContractTransactionFactories[contractInterface] =
            factory;
        return factory;
    }
}
