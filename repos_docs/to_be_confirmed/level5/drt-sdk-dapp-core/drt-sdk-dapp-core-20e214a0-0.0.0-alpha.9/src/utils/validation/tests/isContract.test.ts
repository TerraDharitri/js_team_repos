...
describe('isContract tests', () => {
  ...
  it('returns false for invalid address', () => {
    const valid = isContract('drt1qqqqqqqqqqqqqqqpq');
    expect(valid).toBe(false);
  });
  it('returns true for contract address in data', () => {
    const valid = isContract(
      userAddress,
      undefined,
      'MultiDCDTNFTTransfer@0000000000000000050061506400f3e0c5ea560192716d0daefa0b9587017ceb@02@57524557412d383836303061@@8ac7230489e80000@555344432d613332393036@@464e61d6@6164644c6971756964697479@8963dd8c2c5e0000@459a65fa'
    );
    expect(valid).toBe(true);
  });
});
