...
export class LedgerConnectPanel {
  ...
  private getHeaderContent(accountScreenData: any, confirmScreenData: any) {
    ...
    return (
      <div class="ledger-connect-header">
        ...
        <h4>Unlock your device & open the DharitrI App</h4>
      </div>
    );
  }
  ...
  private getBodyContent(accountScreenData: any, confirmScreenData: any, connectScreenData: any) {
    ...
    if (confirmScreenData) {
      return <drt-ledger-confirm-screen confirmScreenData={confirmScreenData} />;
    }

    return <drt-ledger-connect-screen connectScreenData={connectScreenData} onConnect={this.handleConnect.bind(this)} />;
  }
  ...
  render() {
    ...
    return (
      <drt-side-panel isOpen={this.isOpen} side={SidePanelSideEnum.RIGHT} panelClassName="ledger-connect-panel" onClose={this.handleClose.bind(this)}>
