...
const signScreens = {
  FungibleDCDT: 'token-component',
  SemiFungibleDCDT: 'fungible-component',
  NonFungibleDCDT: 'fungible-component',
  MetaDCDT: 'token-component',
};
...
export class SignTransactionsPanel {
  ...
  render() {
    ...
    return (
      <drt-side-panel isOpen={this.isOpen} side={SidePanelSideEnum.LEFT} panelClassName="sign-transactions-panel" onClose={this.handleClose.bind(this)}>
          ...
          <div class="sign-transactions-body">
            {isLoading ? (
              <div class="loading-spinner">
                <drt-generic-spinner></drt-generic-spinner>
              </div>
            ) : (
