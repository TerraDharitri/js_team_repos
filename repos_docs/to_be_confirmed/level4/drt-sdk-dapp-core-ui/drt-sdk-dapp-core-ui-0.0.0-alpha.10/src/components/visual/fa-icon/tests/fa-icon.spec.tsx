...
describe('FaIcon Component', () => {
  it('should render with icon prop', async () => {
    const page = await newSpecPage({
      components: [FaIcon],
      template: () => <drt-fa-icon icon={faUser}></drt-fa-icon>,
    });
  ...
  it('should not render when icon prop is not provided', async () => {
    const page = await newSpecPage({
      components: [FaIcon],
      template: () => <drt-fa-icon></drt-fa-icon>,
    });
  ...
  it('should apply custom class when provided', async () => {
    const page = await newSpecPage({
      components: [FaIcon],
      template: () => <drt-fa-icon icon={faUser} class="custom-class"></drt-fa-icon>,
    });
  ...
  it('should set description as title when provided', async () => {
    const page = await newSpecPage({
      components: [FaIcon],
      template: () => <drt-fa-icon icon={faUser} description="User Icon"></drt-fa-icon>,
    });
