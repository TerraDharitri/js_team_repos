...
describe('TransactionAccount Component', () => {
  ...
  it('should render locked account icon when showLockedAccounts is true and account is locked', async () => {
    ...
    const page = await newSpecPage({
      components: [TransactionAccount],
      template: () => <drt-transaction-account account={lockedAccount} showLockedAccounts={true} scope="receiver"></drt-transaction-account>,
    });
  ...
  it('should apply custom class and data-testid', async () => {
    const page = await newSpecPage({
      components: [TransactionAccount],
      template: () => <drt-transaction-account account={baseAccount} class="custom-class" dataTestId="test-id" scope="sender"></drt-transaction-account>,
    });
