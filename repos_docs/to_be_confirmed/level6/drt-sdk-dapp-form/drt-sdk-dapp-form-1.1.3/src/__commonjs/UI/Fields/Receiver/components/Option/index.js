"use strict";var Ge=Object.create;var H=Object.defineProperty,$e=Object.defineProperties,Ve=Object.getOwnPropertyDescriptor,Ke=Object.getOwnPropertyDescriptors,Ze=Object.getOwnPropertyNames,le=Object.getOwnPropertySymbols,Je=Object.getPrototypeOf,se=Object.prototype.hasOwnProperty,Qe=Object.prototype.propertyIsEnumerable;var _e=(r,e,o)=>e in r?H(r,e,{enumerable:!0,configurable:!0,writable:!0,value:o}):r[e]=o,Y=(r,e)=>{for(var o in e||(e={}))se.call(e,o)&&_e(r,o,e[o]);if(le)for(var o of le(e))Qe.call(e,o)&&_e(r,o,e[o]);return r},ie=(r,e)=>$e(r,Ke(e));var ae=(r,e)=>()=>(r&&(e=r(r=0)),e);var q=(r,e)=>()=>(e||r((e={exports:{}}).exports,e),e.exports),me=(r,e)=>{for(var o in e)H(r,o,{get:e[o],enumerable:!0})},de=(r,e,o,t)=>{if(e&&typeof e=="object"||typeof e=="function")for(let c of Ze(e))!se.call(r,c)&&c!==o&&H(r,c,{get:()=>e[c],enumerable:!(t=Ve(e,c))||t.enumerable});return r};var D=(r,e,o)=>(o=r!=null?Ge(Je(r)):{},de(e||!r||!r.__esModule?H(o,"default",{value:r,enumerable:!0}):o,r)),ue=r=>de(H({},"__esModule",{value:!0}),r);var fe=q(X=>{"use strict";d();X.byteLength=je;X.toByteArray=oo;X.fromByteArray=co;var E=[],g=[],Pe=typeof Uint8Array!="undefined"?Uint8Array:Array,Z="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";for(C=0,ye=Z.length;C<ye;++C)E[C]=Z[C],g[Z.charCodeAt(C)]=C;var C,ye;g["-".charCodeAt(0)]=62;g["_".charCodeAt(0)]=63;function ve(r){var e=r.length;if(e%4>0)throw new Error("Invalid string. Length must be a multiple of 4");var o=r.indexOf("=");o===-1&&(o=e);var t=o===e?0:4-o%4;return[o,t]}function je(r){var e=ve(r),o=e[0],t=e[1];return(o+t)*3/4-t}function eo(r,e,o){return(e+o)*3/4-o}function oo(r){var e,o=ve(r),t=o[0],c=o[1],n=new Pe(eo(r,t,c)),p=0,_=c>0?t-4:t,s;for(s=0;s<_;s+=4)e=g[r.charCodeAt(s)]<<18|g[r.charCodeAt(s+1)]<<12|g[r.charCodeAt(s+2)]<<6|g[r.charCodeAt(s+3)],n[p++]=e>>16&255,n[p++]=e>>8&255,n[p++]=e&255;return c===2&&(e=g[r.charCodeAt(s)]<<2|g[r.charCodeAt(s+1)]>>4,n[p++]=e&255),c===1&&(e=g[r.charCodeAt(s)]<<10|g[r.charCodeAt(s+1)]<<4|g[r.charCodeAt(s+2)]>>2,n[p++]=e>>8&255,n[p++]=e&255),n}function ro(r){return E[r>>18&63]+E[r>>12&63]+E[r>>6&63]+E[r&63]}function to(r,e,o){for(var t,c=[],n=e;n<o;n+=3)t=(r[n]<<16&16711680)+(r[n+1]<<8&65280)+(r[n+2]&255),c.push(ro(t));return c.join("")}function co(r){for(var e,o=r.length,t=o%3,c=[],n=16383,p=0,_=o-t;p<_;p+=n)c.push(to(r,p,p+n>_?_:p+n));return t===1?(e=r[o-1],c.push(E[e>>2]+E[e<<4&63]+"==")):t===2&&(e=(r[o-2]<<8)+r[o-1],c.push(E[e>>10]+E[e>>4&63]+E[e<<2&63]+"=")),c.join("")}});var he=q(J=>{d();J.read=function(r,e,o,t,c){var n,p,_=c*8-t-1,s=(1<<_)-1,a=s>>1,m=-7,i=o?c-1:0,h=o?-1:1,v=r[e+i];for(i+=h,n=v&(1<<-m)-1,v>>=-m,m+=_;m>0;n=n*256+r[e+i],i+=h,m-=8);for(p=n&(1<<-m)-1,n>>=-m,m+=t;m>0;p=p*256+r[e+i],i+=h,m-=8);if(n===0)n=1-a;else{if(n===s)return p?NaN:(v?-1:1)*(1/0);p=p+Math.pow(2,t),n=n-a}return(v?-1:1)*p*Math.pow(2,n-t)};J.write=function(r,e,o,t,c,n){var p,_,s,a=n*8-c-1,m=(1<<a)-1,i=m>>1,h=c===23?Math.pow(2,-24)-Math.pow(2,-77):0,v=t?0:n-1,N=t?1:-1,Xe=e<0||e===0&&1/e<0?1:0;for(e=Math.abs(e),isNaN(e)||e===1/0?(_=isNaN(e)?1:0,p=m):(p=Math.floor(Math.log(e)/Math.LN2),e*(s=Math.pow(2,-p))<1&&(p--,s*=2),p+i>=1?e+=h/s:e+=h*Math.pow(2,1-i),e*s>=2&&(p++,s/=2),p+i>=m?(_=0,p=m):p+i>=1?(_=(e*s-1)*Math.pow(2,c),p=p+i):(_=e*Math.pow(2,i-1)*Math.pow(2,c),p=0));c>=8;r[o+v]=_&255,v+=N,_/=256,c-=8);for(p=p<<c|_,a+=c;a>0;r[o+v]=p&255,v+=N,p/=256,a-=8);r[o+v-N]|=Xe*128}});var ke=q(O=>{"use strict";d();var Q=fe(),R=he(),ge=typeof Symbol=="function"&&typeof Symbol.for=="function"?Symbol.for("nodejs.util.inspect.custom"):null;O.Buffer=l;O.SlowBuffer=io;O.INSPECT_MAX_BYTES=50;var G=2147483647;O.kMaxLength=G;l.TYPED_ARRAY_SUPPORT=no();!l.TYPED_ARRAY_SUPPORT&&typeof console!="undefined"&&typeof console.error=="function"&&console.error("This browser lacks typed array (Uint8Array) support which is required by `buffer` v5.x. Use `buffer` v4.x if you require old browser support.");function no(){try{var r=new Uint8Array(1),e={foo:function(){return 42}};return Object.setPrototypeOf(e,Uint8Array.prototype),Object.setPrototypeOf(r,e),r.foo()===42}catch(o){return!1}}Object.defineProperty(l.prototype,"parent",{enumerable:!0,get:function(){if(!!l.isBuffer(this))return this.buffer}});Object.defineProperty(l.prototype,"offset",{enumerable:!0,get:function(){if(!!l.isBuffer(this))return this.byteOffset}});function U(r){if(r>G)throw new RangeError('The value "'+r+'" is invalid for option "size"');var e=new Uint8Array(r);return Object.setPrototypeOf(e,l.prototype),e}function l(r,e,o){if(typeof r=="number"){if(typeof e=="string")throw new TypeError('The "string" argument must be of type string. Received type number');return oe(r)}return be(r,e,o)}l.poolSize=8192;function be(r,e,o){if(typeof r=="string")return lo(r,e);if(ArrayBuffer.isView(r))return _o(r);if(r==null)throw new TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+typeof r);if(F(r,ArrayBuffer)||r&&F(r.buffer,ArrayBuffer)||typeof SharedArrayBuffer!="undefined"&&(F(r,SharedArrayBuffer)||r&&F(r.buffer,SharedArrayBuffer)))return j(r,e,o);if(typeof r=="number")throw new TypeError('The "value" argument must not be of type number. Received type number');var t=r.valueOf&&r.valueOf();if(t!=null&&t!==r)return l.from(t,e,o);var c=so(r);if(c)return c;if(typeof Symbol!="undefined"&&Symbol.toPrimitive!=null&&typeof r[Symbol.toPrimitive]=="function")return l.from(r[Symbol.toPrimitive]("string"),e,o);throw new TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+typeof r)}l.from=function(r,e,o){return be(r,e,o)};Object.setPrototypeOf(l.prototype,Uint8Array.prototype);Object.setPrototypeOf(l,Uint8Array);function Ee(r){if(typeof r!="number")throw new TypeError('"size" argument must be of type number');if(r<0)throw new RangeError('The value "'+r+'" is invalid for option "size"')}function po(r,e,o){return Ee(r),r<=0?U(r):e!==void 0?typeof o=="string"?U(r).fill(e,o):U(r).fill(e):U(r)}l.alloc=function(r,e,o){return po(r,e,o)};function oe(r){return Ee(r),U(r<0?0:re(r)|0)}l.allocUnsafe=function(r){return oe(r)};l.allocUnsafeSlow=function(r){return oe(r)};function lo(r,e){if((typeof e!="string"||e==="")&&(e="utf8"),!l.isEncoding(e))throw new TypeError("Unknown encoding: "+e);var o=Fe(r,e)|0,t=U(o),c=t.write(r,e);return c!==o&&(t=t.slice(0,c)),t}function P(r){for(var e=r.length<0?0:re(r.length)|0,o=U(e),t=0;t<e;t+=1)o[t]=r[t]&255;return o}function _o(r){if(F(r,Uint8Array)){var e=new Uint8Array(r);return j(e.buffer,e.byteOffset,e.byteLength)}return P(r)}function j(r,e,o){if(e<0||r.byteLength<e)throw new RangeError('"offset" is outside of buffer bounds');if(r.byteLength<e+(o||0))throw new RangeError('"length" is outside of buffer bounds');var t;return e===void 0&&o===void 0?t=new Uint8Array(r):o===void 0?t=new Uint8Array(r,e):t=new Uint8Array(r,e,o),Object.setPrototypeOf(t,l.prototype),t}function so(r){if(l.isBuffer(r)){var e=re(r.length)|0,o=U(e);return o.length===0||r.copy(o,0,0,e),o}if(r.length!==void 0)return typeof r.length!="number"||te(r.length)?U(0):P(r);if(r.type==="Buffer"&&Array.isArray(r.data))return P(r.data)}function re(r){if(r>=G)throw new RangeError("Attempt to allocate Buffer larger than maximum size: 0x"+G.toString(16)+" bytes");return r|0}function io(r){return+r!=r&&(r=0),l.alloc(+r)}l.isBuffer=function(e){return e!=null&&e._isBuffer===!0&&e!==l.prototype};l.compare=function(e,o){if(F(e,Uint8Array)&&(e=l.from(e,e.offset,e.byteLength)),F(o,Uint8Array)&&(o=l.from(o,o.offset,o.byteLength)),!l.isBuffer(e)||!l.isBuffer(o))throw new TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');if(e===o)return 0;for(var t=e.length,c=o.length,n=0,p=Math.min(t,c);n<p;++n)if(e[n]!==o[n]){t=e[n],c=o[n];break}return t<c?-1:c<t?1:0};l.isEncoding=function(e){switch(String(e).toLowerCase()){case"hex":case"utf8":case"utf-8":case"ascii":case"latin1":case"binary":case"base64":case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return!0;default:return!1}};l.concat=function(e,o){if(!Array.isArray(e))throw new TypeError('"list" argument must be an Array of Buffers');if(e.length===0)return l.alloc(0);var t;if(o===void 0)for(o=0,t=0;t<e.length;++t)o+=e[t].length;var c=l.allocUnsafe(o),n=0;for(t=0;t<e.length;++t){var p=e[t];if(F(p,Uint8Array))n+p.length>c.length?l.from(p).copy(c,n):Uint8Array.prototype.set.call(c,p,n);else if(l.isBuffer(p))p.copy(c,n);else throw new TypeError('"list" argument must be an Array of Buffers');n+=p.length}return c};function Fe(r,e){if(l.isBuffer(r))return r.length;if(ArrayBuffer.isView(r)||F(r,ArrayBuffer))return r.byteLength;if(typeof r!="string")throw new TypeError('The "string" argument must be one of type string, Buffer, or ArrayBuffer. Received type '+typeof r);var o=r.length,t=arguments.length>2&&arguments[2]===!0;if(!t&&o===0)return 0;for(var c=!1;;)switch(e){case"ascii":case"latin1":case"binary":return o;case"utf8":case"utf-8":return ee(r).length;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return o*2;case"hex":return o>>>1;case"base64":return Se(r).length;default:if(c)return t?-1:ee(r).length;e=(""+e).toLowerCase(),c=!0}}l.byteLength=Fe;function ao(r,e,o){var t=!1;if((e===void 0||e<0)&&(e=0),e>this.length||((o===void 0||o>this.length)&&(o=this.length),o<=0)||(o>>>=0,e>>>=0,o<=e))return"";for(r||(r="utf8");;)switch(r){case"hex":return bo(this,e,o);case"utf8":case"utf-8":return Be(this,e,o);case"ascii":return xo(this,e,o);case"latin1":case"binary":return wo(this,e,o);case"base64":return ho(this,e,o);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return Eo(this,e,o);default:if(t)throw new TypeError("Unknown encoding: "+r);r=(r+"").toLowerCase(),t=!0}}l.prototype._isBuffer=!0;function L(r,e,o){var t=r[e];r[e]=r[o],r[o]=t}l.prototype.swap16=function(){var e=this.length;if(e%2!==0)throw new RangeError("Buffer size must be a multiple of 16-bits");for(var o=0;o<e;o+=2)L(this,o,o+1);return this};l.prototype.swap32=function(){var e=this.length;if(e%4!==0)throw new RangeError("Buffer size must be a multiple of 32-bits");for(var o=0;o<e;o+=4)L(this,o,o+3),L(this,o+1,o+2);return this};l.prototype.swap64=function(){var e=this.length;if(e%8!==0)throw new RangeError("Buffer size must be a multiple of 64-bits");for(var o=0;o<e;o+=8)L(this,o,o+7),L(this,o+1,o+6),L(this,o+2,o+5),L(this,o+3,o+4);return this};l.prototype.toString=function(){var e=this.length;return e===0?"":arguments.length===0?Be(this,0,e):ao.apply(this,arguments)};l.prototype.toLocaleString=l.prototype.toString;l.prototype.equals=function(e){if(!l.isBuffer(e))throw new TypeError("Argument must be a Buffer");return this===e?!0:l.compare(this,e)===0};l.prototype.inspect=function(){var e="",o=O.INSPECT_MAX_BYTES;return e=this.toString("hex",0,o).replace(/(.{2})/g,"$1 ").trim(),this.length>o&&(e+=" ... "),"<Buffer "+e+">"};ge&&(l.prototype[ge]=l.prototype.inspect);l.prototype.compare=function(e,o,t,c,n){if(F(e,Uint8Array)&&(e=l.from(e,e.offset,e.byteLength)),!l.isBuffer(e))throw new TypeError('The "target" argument must be one of type Buffer or Uint8Array. Received type '+typeof e);if(o===void 0&&(o=0),t===void 0&&(t=e?e.length:0),c===void 0&&(c=0),n===void 0&&(n=this.length),o<0||t>e.length||c<0||n>this.length)throw new RangeError("out of range index");if(c>=n&&o>=t)return 0;if(c>=n)return-1;if(o>=t)return 1;if(o>>>=0,t>>>=0,c>>>=0,n>>>=0,this===e)return 0;for(var p=n-c,_=t-o,s=Math.min(p,_),a=this.slice(c,n),m=e.slice(o,t),i=0;i<s;++i)if(a[i]!==m[i]){p=a[i],_=m[i];break}return p<_?-1:_<p?1:0};function Ae(r,e,o,t,c){if(r.length===0)return-1;if(typeof o=="string"?(t=o,o=0):o>2147483647?o=2147483647:o<-2147483648&&(o=-2147483648),o=+o,te(o)&&(o=c?0:r.length-1),o<0&&(o=r.length+o),o>=r.length){if(c)return-1;o=r.length-1}else if(o<0)if(c)o=0;else return-1;if(typeof e=="string"&&(e=l.from(e,t)),l.isBuffer(e))return e.length===0?-1:xe(r,e,o,t,c);if(typeof e=="number")return e=e&255,typeof Uint8Array.prototype.indexOf=="function"?c?Uint8Array.prototype.indexOf.call(r,e,o):Uint8Array.prototype.lastIndexOf.call(r,e,o):xe(r,[e],o,t,c);throw new TypeError("val must be string, number or Buffer")}function xe(r,e,o,t,c){var n=1,p=r.length,_=e.length;if(t!==void 0&&(t=String(t).toLowerCase(),t==="ucs2"||t==="ucs-2"||t==="utf16le"||t==="utf-16le")){if(r.length<2||e.length<2)return-1;n=2,p/=2,_/=2,o/=2}function s(v,N){return n===1?v[N]:v.readUInt16BE(N*n)}var a;if(c){var m=-1;for(a=o;a<p;a++)if(s(r,a)===s(e,m===-1?0:a-m)){if(m===-1&&(m=a),a-m+1===_)return m*n}else m!==-1&&(a-=a-m),m=-1}else for(o+_>p&&(o=p-_),a=o;a>=0;a--){for(var i=!0,h=0;h<_;h++)if(s(r,a+h)!==s(e,h)){i=!1;break}if(i)return a}return-1}l.prototype.includes=function(e,o,t){return this.indexOf(e,o,t)!==-1};l.prototype.indexOf=function(e,o,t){return Ae(this,e,o,t,!0)};l.prototype.lastIndexOf=function(e,o,t){return Ae(this,e,o,t,!1)};function mo(r,e,o,t){o=Number(o)||0;var c=r.length-o;t?(t=Number(t),t>c&&(t=c)):t=c;var n=e.length;t>n/2&&(t=n/2);for(var p=0;p<t;++p){var _=parseInt(e.substr(p*2,2),16);if(te(_))return p;r[o+p]=_}return p}function uo(r,e,o,t){return $(ee(e,r.length-o),r,o,t)}function yo(r,e,o,t){return $(Bo(e),r,o,t)}function vo(r,e,o,t){return $(Se(e),r,o,t)}function fo(r,e,o,t){return $(To(e,r.length-o),r,o,t)}l.prototype.write=function(e,o,t,c){if(o===void 0)c="utf8",t=this.length,o=0;else if(t===void 0&&typeof o=="string")c=o,t=this.length,o=0;else if(isFinite(o))o=o>>>0,isFinite(t)?(t=t>>>0,c===void 0&&(c="utf8")):(c=t,t=void 0);else throw new Error("Buffer.write(string, encoding, offset[, length]) is no longer supported");var n=this.length-o;if((t===void 0||t>n)&&(t=n),e.length>0&&(t<0||o<0)||o>this.length)throw new RangeError("Attempt to write outside buffer bounds");c||(c="utf8");for(var p=!1;;)switch(c){case"hex":return mo(this,e,o,t);case"utf8":case"utf-8":return uo(this,e,o,t);case"ascii":case"latin1":case"binary":return yo(this,e,o,t);case"base64":return vo(this,e,o,t);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return fo(this,e,o,t);default:if(p)throw new TypeError("Unknown encoding: "+c);c=(""+c).toLowerCase(),p=!0}};l.prototype.toJSON=function(){return{type:"Buffer",data:Array.prototype.slice.call(this._arr||this,0)}};function ho(r,e,o){return e===0&&o===r.length?Q.fromByteArray(r):Q.fromByteArray(r.slice(e,o))}function Be(r,e,o){o=Math.min(r.length,o);for(var t=[],c=e;c<o;){var n=r[c],p=null,_=n>239?4:n>223?3:n>191?2:1;if(c+_<=o){var s,a,m,i;switch(_){case 1:n<128&&(p=n);break;case 2:s=r[c+1],(s&192)===128&&(i=(n&31)<<6|s&63,i>127&&(p=i));break;case 3:s=r[c+1],a=r[c+2],(s&192)===128&&(a&192)===128&&(i=(n&15)<<12|(s&63)<<6|a&63,i>2047&&(i<55296||i>57343)&&(p=i));break;case 4:s=r[c+1],a=r[c+2],m=r[c+3],(s&192)===128&&(a&192)===128&&(m&192)===128&&(i=(n&15)<<18|(s&63)<<12|(a&63)<<6|m&63,i>65535&&i<1114112&&(p=i))}}p===null?(p=65533,_=1):p>65535&&(p-=65536,t.push(p>>>10&1023|55296),p=56320|p&1023),t.push(p),c+=_}return go(t)}var we=4096;function go(r){var e=r.length;if(e<=we)return String.fromCharCode.apply(String,r);for(var o="",t=0;t<e;)o+=String.fromCharCode.apply(String,r.slice(t,t+=we));return o}function xo(r,e,o){var t="";o=Math.min(r.length,o);for(var c=e;c<o;++c)t+=String.fromCharCode(r[c]&127);return t}function wo(r,e,o){var t="";o=Math.min(r.length,o);for(var c=e;c<o;++c)t+=String.fromCharCode(r[c]);return t}function bo(r,e,o){var t=r.length;(!e||e<0)&&(e=0),(!o||o<0||o>t)&&(o=t);for(var c="",n=e;n<o;++n)c+=Uo[r[n]];return c}function Eo(r,e,o){for(var t=r.slice(e,o),c="",n=0;n<t.length-1;n+=2)c+=String.fromCharCode(t[n]+t[n+1]*256);return c}l.prototype.slice=function(e,o){var t=this.length;e=~~e,o=o===void 0?t:~~o,e<0?(e+=t,e<0&&(e=0)):e>t&&(e=t),o<0?(o+=t,o<0&&(o=0)):o>t&&(o=t),o<e&&(o=e);var c=this.subarray(e,o);return Object.setPrototypeOf(c,l.prototype),c};function y(r,e,o){if(r%1!==0||r<0)throw new RangeError("offset is not uint");if(r+e>o)throw new RangeError("Trying to access beyond buffer length")}l.prototype.readUintLE=l.prototype.readUIntLE=function(e,o,t){e=e>>>0,o=o>>>0,t||y(e,o,this.length);for(var c=this[e],n=1,p=0;++p<o&&(n*=256);)c+=this[e+p]*n;return c};l.prototype.readUintBE=l.prototype.readUIntBE=function(e,o,t){e=e>>>0,o=o>>>0,t||y(e,o,this.length);for(var c=this[e+--o],n=1;o>0&&(n*=256);)c+=this[e+--o]*n;return c};l.prototype.readUint8=l.prototype.readUInt8=function(e,o){return e=e>>>0,o||y(e,1,this.length),this[e]};l.prototype.readUint16LE=l.prototype.readUInt16LE=function(e,o){return e=e>>>0,o||y(e,2,this.length),this[e]|this[e+1]<<8};l.prototype.readUint16BE=l.prototype.readUInt16BE=function(e,o){return e=e>>>0,o||y(e,2,this.length),this[e]<<8|this[e+1]};l.prototype.readUint32LE=l.prototype.readUInt32LE=function(e,o){return e=e>>>0,o||y(e,4,this.length),(this[e]|this[e+1]<<8|this[e+2]<<16)+this[e+3]*16777216};l.prototype.readUint32BE=l.prototype.readUInt32BE=function(e,o){return e=e>>>0,o||y(e,4,this.length),this[e]*16777216+(this[e+1]<<16|this[e+2]<<8|this[e+3])};l.prototype.readIntLE=function(e,o,t){e=e>>>0,o=o>>>0,t||y(e,o,this.length);for(var c=this[e],n=1,p=0;++p<o&&(n*=256);)c+=this[e+p]*n;return n*=128,c>=n&&(c-=Math.pow(2,8*o)),c};l.prototype.readIntBE=function(e,o,t){e=e>>>0,o=o>>>0,t||y(e,o,this.length);for(var c=o,n=1,p=this[e+--c];c>0&&(n*=256);)p+=this[e+--c]*n;return n*=128,p>=n&&(p-=Math.pow(2,8*o)),p};l.prototype.readInt8=function(e,o){return e=e>>>0,o||y(e,1,this.length),this[e]&128?(255-this[e]+1)*-1:this[e]};l.prototype.readInt16LE=function(e,o){e=e>>>0,o||y(e,2,this.length);var t=this[e]|this[e+1]<<8;return t&32768?t|4294901760:t};l.prototype.readInt16BE=function(e,o){e=e>>>0,o||y(e,2,this.length);var t=this[e+1]|this[e]<<8;return t&32768?t|4294901760:t};l.prototype.readInt32LE=function(e,o){return e=e>>>0,o||y(e,4,this.length),this[e]|this[e+1]<<8|this[e+2]<<16|this[e+3]<<24};l.prototype.readInt32BE=function(e,o){return e=e>>>0,o||y(e,4,this.length),this[e]<<24|this[e+1]<<16|this[e+2]<<8|this[e+3]};l.prototype.readFloatLE=function(e,o){return e=e>>>0,o||y(e,4,this.length),R.read(this,e,!0,23,4)};l.prototype.readFloatBE=function(e,o){return e=e>>>0,o||y(e,4,this.length),R.read(this,e,!1,23,4)};l.prototype.readDoubleLE=function(e,o){return e=e>>>0,o||y(e,8,this.length),R.read(this,e,!0,52,8)};l.prototype.readDoubleBE=function(e,o){return e=e>>>0,o||y(e,8,this.length),R.read(this,e,!1,52,8)};function f(r,e,o,t,c,n){if(!l.isBuffer(r))throw new TypeError('"buffer" argument must be a Buffer instance');if(e>c||e<n)throw new RangeError('"value" argument is out of bounds');if(o+t>r.length)throw new RangeError("Index out of range")}l.prototype.writeUintLE=l.prototype.writeUIntLE=function(e,o,t,c){if(e=+e,o=o>>>0,t=t>>>0,!c){var n=Math.pow(2,8*t)-1;f(this,e,o,t,n,0)}var p=1,_=0;for(this[o]=e&255;++_<t&&(p*=256);)this[o+_]=e/p&255;return o+t};l.prototype.writeUintBE=l.prototype.writeUIntBE=function(e,o,t,c){if(e=+e,o=o>>>0,t=t>>>0,!c){var n=Math.pow(2,8*t)-1;f(this,e,o,t,n,0)}var p=t-1,_=1;for(this[o+p]=e&255;--p>=0&&(_*=256);)this[o+p]=e/_&255;return o+t};l.prototype.writeUint8=l.prototype.writeUInt8=function(e,o,t){return e=+e,o=o>>>0,t||f(this,e,o,1,255,0),this[o]=e&255,o+1};l.prototype.writeUint16LE=l.prototype.writeUInt16LE=function(e,o,t){return e=+e,o=o>>>0,t||f(this,e,o,2,65535,0),this[o]=e&255,this[o+1]=e>>>8,o+2};l.prototype.writeUint16BE=l.prototype.writeUInt16BE=function(e,o,t){return e=+e,o=o>>>0,t||f(this,e,o,2,65535,0),this[o]=e>>>8,this[o+1]=e&255,o+2};l.prototype.writeUint32LE=l.prototype.writeUInt32LE=function(e,o,t){return e=+e,o=o>>>0,t||f(this,e,o,4,4294967295,0),this[o+3]=e>>>24,this[o+2]=e>>>16,this[o+1]=e>>>8,this[o]=e&255,o+4};l.prototype.writeUint32BE=l.prototype.writeUInt32BE=function(e,o,t){return e=+e,o=o>>>0,t||f(this,e,o,4,4294967295,0),this[o]=e>>>24,this[o+1]=e>>>16,this[o+2]=e>>>8,this[o+3]=e&255,o+4};l.prototype.writeIntLE=function(e,o,t,c){if(e=+e,o=o>>>0,!c){var n=Math.pow(2,8*t-1);f(this,e,o,t,n-1,-n)}var p=0,_=1,s=0;for(this[o]=e&255;++p<t&&(_*=256);)e<0&&s===0&&this[o+p-1]!==0&&(s=1),this[o+p]=(e/_>>0)-s&255;return o+t};l.prototype.writeIntBE=function(e,o,t,c){if(e=+e,o=o>>>0,!c){var n=Math.pow(2,8*t-1);f(this,e,o,t,n-1,-n)}var p=t-1,_=1,s=0;for(this[o+p]=e&255;--p>=0&&(_*=256);)e<0&&s===0&&this[o+p+1]!==0&&(s=1),this[o+p]=(e/_>>0)-s&255;return o+t};l.prototype.writeInt8=function(e,o,t){return e=+e,o=o>>>0,t||f(this,e,o,1,127,-128),e<0&&(e=255+e+1),this[o]=e&255,o+1};l.prototype.writeInt16LE=function(e,o,t){return e=+e,o=o>>>0,t||f(this,e,o,2,32767,-32768),this[o]=e&255,this[o+1]=e>>>8,o+2};l.prototype.writeInt16BE=function(e,o,t){return e=+e,o=o>>>0,t||f(this,e,o,2,32767,-32768),this[o]=e>>>8,this[o+1]=e&255,o+2};l.prototype.writeInt32LE=function(e,o,t){return e=+e,o=o>>>0,t||f(this,e,o,4,2147483647,-2147483648),this[o]=e&255,this[o+1]=e>>>8,this[o+2]=e>>>16,this[o+3]=e>>>24,o+4};l.prototype.writeInt32BE=function(e,o,t){return e=+e,o=o>>>0,t||f(this,e,o,4,2147483647,-2147483648),e<0&&(e=4294967295+e+1),this[o]=e>>>24,this[o+1]=e>>>16,this[o+2]=e>>>8,this[o+3]=e&255,o+4};function Te(r,e,o,t,c,n){if(o+t>r.length)throw new RangeError("Index out of range");if(o<0)throw new RangeError("Index out of range")}function Ue(r,e,o,t,c){return e=+e,o=o>>>0,c||Te(r,e,o,4,34028234663852886e22,-34028234663852886e22),R.write(r,e,o,t,23,4),o+4}l.prototype.writeFloatLE=function(e,o,t){return Ue(this,e,o,!0,t)};l.prototype.writeFloatBE=function(e,o,t){return Ue(this,e,o,!1,t)};function Ie(r,e,o,t,c){return e=+e,o=o>>>0,c||Te(r,e,o,8,17976931348623157e292,-17976931348623157e292),R.write(r,e,o,t,52,8),o+8}l.prototype.writeDoubleLE=function(e,o,t){return Ie(this,e,o,!0,t)};l.prototype.writeDoubleBE=function(e,o,t){return Ie(this,e,o,!1,t)};l.prototype.copy=function(e,o,t,c){if(!l.isBuffer(e))throw new TypeError("argument should be a Buffer");if(t||(t=0),!c&&c!==0&&(c=this.length),o>=e.length&&(o=e.length),o||(o=0),c>0&&c<t&&(c=t),c===t||e.length===0||this.length===0)return 0;if(o<0)throw new RangeError("targetStart out of bounds");if(t<0||t>=this.length)throw new RangeError("Index out of range");if(c<0)throw new RangeError("sourceEnd out of bounds");c>this.length&&(c=this.length),e.length-o<c-t&&(c=e.length-o+t);var n=c-t;return this===e&&typeof Uint8Array.prototype.copyWithin=="function"?this.copyWithin(o,t,c):Uint8Array.prototype.set.call(e,this.subarray(t,c),o),n};l.prototype.fill=function(e,o,t,c){if(typeof e=="string"){if(typeof o=="string"?(c=o,o=0,t=this.length):typeof t=="string"&&(c=t,t=this.length),c!==void 0&&typeof c!="string")throw new TypeError("encoding must be a string");if(typeof c=="string"&&!l.isEncoding(c))throw new TypeError("Unknown encoding: "+c);if(e.length===1){var n=e.charCodeAt(0);(c==="utf8"&&n<128||c==="latin1")&&(e=n)}}else typeof e=="number"?e=e&255:typeof e=="boolean"&&(e=Number(e));if(o<0||this.length<o||this.length<t)throw new RangeError("Out of range index");if(t<=o)return this;o=o>>>0,t=t===void 0?this.length:t>>>0,e||(e=0);var p;if(typeof e=="number")for(p=o;p<t;++p)this[p]=e;else{var _=l.isBuffer(e)?e:l.from(e,c),s=_.length;if(s===0)throw new TypeError('The value "'+e+'" is invalid for argument "value"');for(p=0;p<t-o;++p)this[p+o]=_[p%s]}return this};var Fo=/[^+/0-9A-Za-z-_]/g;function Ao(r){if(r=r.split("=")[0],r=r.trim().replace(Fo,""),r.length<2)return"";for(;r.length%4!==0;)r=r+"=";return r}function ee(r,e){e=e||1/0;for(var o,t=r.length,c=null,n=[],p=0;p<t;++p){if(o=r.charCodeAt(p),o>55295&&o<57344){if(!c){if(o>56319){(e-=3)>-1&&n.push(239,191,189);continue}else if(p+1===t){(e-=3)>-1&&n.push(239,191,189);continue}c=o;continue}if(o<56320){(e-=3)>-1&&n.push(239,191,189),c=o;continue}o=(c-55296<<10|o-56320)+65536}else c&&(e-=3)>-1&&n.push(239,191,189);if(c=null,o<128){if((e-=1)<0)break;n.push(o)}else if(o<2048){if((e-=2)<0)break;n.push(o>>6|192,o&63|128)}else if(o<65536){if((e-=3)<0)break;n.push(o>>12|224,o>>6&63|128,o&63|128)}else if(o<1114112){if((e-=4)<0)break;n.push(o>>18|240,o>>12&63|128,o>>6&63|128,o&63|128)}else throw new Error("Invalid code point")}return n}function Bo(r){for(var e=[],o=0;o<r.length;++o)e.push(r.charCodeAt(o)&255);return e}function To(r,e){for(var o,t,c,n=[],p=0;p<r.length&&!((e-=2)<0);++p)o=r.charCodeAt(p),t=o>>8,c=o%256,n.push(c),n.push(t);return n}function Se(r){return Q.toByteArray(Ao(r))}function $(r,e,o,t){for(var c=0;c<t&&!(c+o>=e.length||c>=r.length);++c)e[c+o]=r[c];return c}function F(r,e){return r instanceof e||r!=null&&r.constructor!=null&&r.constructor.name!=null&&r.constructor.name===e.name}function te(r){return r!==r}var Uo=function(){for(var r="0123456789abcdef",e=new Array(256),o=0;o<16;++o)for(var t=o*16,c=0;c<16;++c)e[t+c]=r[o]+r[c];return e}()});var De=q((Wo,Ne)=>{d();var u=Ne.exports={},A,B;function ce(){throw new Error("setTimeout has not been defined")}function ne(){throw new Error("clearTimeout has not been defined")}(function(){try{typeof setTimeout=="function"?A=setTimeout:A=ce}catch(r){A=ce}try{typeof clearTimeout=="function"?B=clearTimeout:B=ne}catch(r){B=ne}})();function Ce(r){if(A===setTimeout)return setTimeout(r,0);if((A===ce||!A)&&setTimeout)return A=setTimeout,setTimeout(r,0);try{return A(r,0)}catch(e){try{return A.call(null,r,0)}catch(o){return A.call(this,r,0)}}}function Io(r){if(B===clearTimeout)return clearTimeout(r);if((B===ne||!B)&&clearTimeout)return B=clearTimeout,clearTimeout(r);try{return B(r)}catch(e){try{return B.call(null,r)}catch(o){return B.call(this,r)}}}var I=[],z=!1,M,V=-1;function So(){!z||!M||(z=!1,M.length?I=M.concat(I):V=-1,I.length&&Le())}function Le(){if(!z){var r=Ce(So);z=!0;for(var e=I.length;e;){for(M=I,I=[];++V<e;)M&&M[V].run();V=-1,e=I.length}M=null,z=!1,Io(r)}}u.nextTick=function(r){var e=new Array(arguments.length-1);if(arguments.length>1)for(var o=1;o<arguments.length;o++)e[o-1]=arguments[o];I.push(new Me(r,e)),I.length===1&&!z&&Ce(Le)};function Me(r,e){this.fun=r,this.array=e}Me.prototype.run=function(){this.fun.apply(null,this.array)};u.title="browser";u.browser=!0;u.env={};u.argv=[];u.version="";u.versions={};function S(){}u.on=S;u.addListener=S;u.once=S;u.off=S;u.removeListener=S;u.removeAllListeners=S;u.emit=S;u.prependListener=S;u.prependOnceListener=S;u.listeners=function(r){return[]};u.binding=function(r){throw new Error("process.binding is not supported")};u.cwd=function(){return"/"};u.chdir=function(r){throw new Error("process.chdir is not supported")};u.umask=function(){return 0}});var x,w,Yo,d=ae(()=>{x=D(ke()),w=D(De()),Yo=function(r){function e(){var t=this||self;return delete r.prototype.__magic__,t}if(typeof globalThis=="object")return globalThis;if(this)return e();r.defineProperty(r.prototype,"__magic__",{configurable:!0,get:e});var o=__magic__;return o}(Object)});var ze={};me(ze,{default:()=>Mo});var K,Lo,Mo,He=ae(()=>{"use strict";d();K=D(require("react")),Lo=r=>K.createElement("svg",Y({width:200,height:200,viewBox:"5 5 10.55 21",fill:"#23f7dd",xmlns:"http://www.w3.org/2000/svg",className:"herotag-logo"},r),K.createElement("g",null,K.createElement("path",{d:"M11.3288 15.0673L20.4563 10.168L18.9218 7.20471L10.5638 10.6011C10.3486 10.6887 10.11 10.6887 9.89482 10.6011L1.53452 7.20708L0 10.168L9.12756 15.0673L0 19.9666L1.53452 22.9299L9.89248 19.5335C10.1077 19.4459 10.3463 19.4459 10.5615 19.5335L18.9195 22.9299L20.454 19.9666L11.3264 15.0673H11.3288Z"}))),Mo=Lo});var Do={};me(Do,{Option:()=>No});module.exports=ue(Do);d();d();var T=D(require("react")),pe=require("@terradharitri/sdk-dapp/UI/Trim"),Ye=D(require("classnames")),qe=require("react-select");d();d();var W=D(require("react"));d();var ko=`.dapp-core-component__styles-modules__highlight {
  display: flex;
  align-items: center;
  gap: 4px;
}`;document.head.appendChild(document.createElement("style")).appendChild(document.createTextNode(ko));var Re={highlight:"dapp-core-component__styles-modules__highlight"};var Oe=({highlight:r,text:e=""})=>{let o=e.split(" "),t=r.toLowerCase(),c=new RegExp(`(${t})`,"gi"),n=o.map(p=>p.split(c).filter(_=>_));return W.default.createElement("span",{className:Re.highlight},n.map((p,_)=>{let s=`${p}-${_}`;return W.default.createElement("span",{key:s},p.map((a,m)=>{let i=a.toLowerCase()===t,h=t&&i,v=`${a}-${m}`;return h?W.default.createElement("strong",{key:v},a):W.default.createElement("span",{key:v},a)}))}))};d();var Co=`:root {
  --primary: #1b46c2;
