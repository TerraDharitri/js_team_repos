...
.dapp-core-component__styles-module__confirmReceiver .dapp-core-component__styles-module__icon {
  ...
  width: auto;
  top: 1px;
}`;document.head.appendChild(document.createElement("style")).appendChild(document.createTextNode(Se));var E={confirmReceiver:"dapp-core-component__styles-module__confirmReceiver",value:"dapp-core-component__styles-module__value",shrunk:"dapp-core-component__styles-module__shrunk",subValue:"dapp-core-component__styles-module__subValue",subValueTrim:"dapp-core-component__styles-module__subValueTrim",subValueCopy:"dapp-core-component__styles-module__subValueCopy",explorer:"dapp-core-component__styles-module__explorer",icon:"dapp-core-component__styles-module__icon"};var Re=({label:o="Receiver",receiver:r,scamReport:e,receiverUsername:n})=>{let t=Boolean(n),i=n!=null?n:r;return g.default.createElement("div",{className:E.confirmReceiver},g.default.createElement("span",{className:Ir.label},o),g.default.createElement("span",{className:(0,Hr.default)(E.value,{[E.shrunk]:t}),"data-testid":"confirmReceiver"},t&&g.default.createElement(Vr,{className:E.icon}),i,t&&g.default.createElement(Xr.ExplorerLink,{page:`/${Pr.ACCOUNTS_ENDPOINT}/${r}`,className:E.explorer})),t&&g.default.createElement("span",{className:E.subValue},g.default.createElement(Yr.Trim,{text:r,className:E.subValueTrim}),g.default.createElement(qr.CopyButton,{text:r,className:E.subValueCopy})),e&&g.default.createElement("div",{className:E.scam},g.default.createElement("span",null,g.default.createElement(Wr.FontAwesomeIcon,{icon:zr.faExclamationTriangle,className:E.icon}),g.default.createElement("small",{"data-testid":"confirmScamReport"},e))))};0&&(module.exports={Receiver});
/*!
