...
}`;document.head.appendChild(document.createElement("style")).appendChild(document.createTextNode(Yn));var le={advanced:"dapp-core-component__styles-module__advanced","advanced-text":"dapp-core-component__styles-module__advanced-text",advancedText:"dapp-core-component__styles-module__advanced-text"};var $r=()=>{let{formInfo:{readonly:t,isRewaTransaction:e}}=ce(),{setFieldValue:r,values:o}=(0,Or.useFormikContext)(),[i,p]=(0,A.useState)(!1),[m,u]=(0,A.useState)(!1),d=_e(),x=!i&&!t&&d&&Boolean(o.data),h=()=>{p(!0),r("isAdvancedModeEnabled",!0)},g=()=>{u(!0),setTimeout(()=>{u(!1)},5e3)};return(0,A.useEffect)(()=>{!e&&i&&p(!1)},[e,o.amount]),x?m?A.default.createElement("div",{className:le.advanced,"data-testid":"confirmAdvancedMode",onClick:h},A.default.createElement(Ze.FontAwesomeIcon,{icon:Ie.faCheck,className:"i-icon"}),A.default.createElement("span",{className:le.advancedText},"Confirm")):A.default.createElement("div",{"data-testid":"enableAdvancedMode",className:le.advanced,onClick:g},A.default.createElement(Ze.FontAwesomeIcon,{icon:Ie.faScrewdriverWrench,className:"i-icon"}),A.default.createElement("span",{className:le.advancedText},"Advanced")):null};n();var Qn=`:root {
  --primary: #1b46c2;
  --primary-light: #1392ff;
  --border-color: #dee2e6;
  --card-bg: white;
...
.dapp-core-component__styles-module__data .dapp-core-component__styles-module__wrapper {
  display: flex;
  position: relative;
}`;document.head.appendChild(document.createElement("style")).appendChild(document.createTextNode(Qn));var ze={data:"dapp-core-component__styles-module__data",wrapper:"dapp-core-component__styles-module__wrapper"};var ei=({className:t})=>{let{dataFieldInfo:{data:e,dataError:r,isDataInvalid:o,onChange:i,onBlur:p}}=ce(),m=_e();return M.default.createElement("div",{className:(0,He.default)(ze.data,t)},M.default.createElement("div",{className:qr.label},M.default.createElement("label",{htmlFor:"data",className:J.label},"Data"),M.default.createElement($r,null)),M.default.createElement("div",{className:ze.wrapper},M.default.createElement("textarea",{rows:1,id:"data",name:"data",disabled:m,"data-testid":"data",value:e,onBlur:p,onChange:i,spellCheck:"false",placeholder:"Add transaction data",className:(0,He.default)(J.textarea,{[J.invalid]:o,[J.disabled]:m})})),o&&M.default.createElement("div",{className:J.error,"data-testid":"dataError"},r))};0&&(module.exports={Data});
/*!
