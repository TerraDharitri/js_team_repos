...
.dapp-core-component__styles-module__amount .dapp-core-component__styles-module__price {
  ...
  line-height: 1;
  margin-top: 8px;
}`;document.head.appendChild(document.createElement("style")).appendChild(document.createTextNode(Aa));var Ne={amount:"dapp-core-component__styles-module__amount",token:"dapp-core-component__styles-module__token",value:"dapp-core-component__styles-module__value",price:"dapp-core-component__styles-module__price"};var Vt=({label:t="Amount",amount:e,txType:r,tokenDecimals:o,tokenId:i,rewaLabel:p,rewaPriceInUsd:m,nft:d,tokenAvatar:f})=>{let x=(d==null?void 0:d.decimals)||0,g=r==="DCDT",y=r==="MetaDCDT",h=r==="NonFungibleDCDT",b=y?(0,D.parseAmount)(e,d==null?void 0:d.decimals):e,w=Boolean(d&&e),A=i.split("-")[0],P=g?o:Qe.DECIMALS,Z=w?J.default.createElement(Pr.FormatAmount,{rewaLabel:p,value:b,decimals:x,digits:r==="MetaDCDT"?Qe.DIGITS:0,showLabel:!1,showLastNonZeroDecimal:!0,"data-testid":"confirmAmount"}):J.default.createElement(Pr.FormatAmount,{rewaLabel:p,value:(0,D.parseAmount)(e,P),showLabel:!1,decimals:P,showLastNonZeroDecimal:!0,token:g?A:p,"data-testid":"confirmAmount"});return h?null:J.default.createElement("div",{className:Ne.amount},J.default.createElement("span",{className:S.label},t),J.default.createElement("div",{className:Ne.token},J.default.createElement(Ye,{type:r,avatar:f}),J.default.createElement("div",{className:Ne.value},Z," ",A)),!g&&J.default.createElement(Ut.UsdValue,{amount:e,usd:m,"data-testid":"confirmUsdValue",className:Ne.price}))};n();n();var E=u(require("react")),Mt=require("@terradharitri/sdk-dapp/utils/decoders/decodePart");n();var ka=`:root {
  --primary: #1b46c2;
  --primary-light: #1392ff;
  --border-color: #dee2e6;
  --card-bg: white;
...
}`;document.head.appendChild(document.createElement("style")).appendChild(document.createTextNode(ka));var Le={data:"dapp-core-component__styles-module__data",value:"dapp-core-component__styles-module__value"};var Sa=(t,e)=>[...t.matchAll(new RegExp(e,"gi"))].map(r=>r.index),Rt=({label:t="Data",scCallLabel:e="SC Call",data:r,highlight:o,isScCall:i})=>{let p=E.default.createElement(E.default.Fragment,null,r),[m,...d]=o&&i?o.split("@"):[];if(r&&o&&Sa(r,o).length===1)switch(!0){case r.startsWith(o):{let[,f]=r.split(o);p=E.default.createElement(E.default.Fragment,null,o,E.default.createElement("span",null,f));break}case r.endsWith(o):{let[f]=r.split(o);p=E.default.createElement(E.default.Fragment,null,E.default.createElement("span",null,f),o);break}default:{let[f,x]=r.split(o);p=E.default.createElement(E.default.Fragment,null,E.default.createElement("span",null,f),o,E.default.createElement("span",null,x));break}}return E.default.createElement(E.default.Fragment,null,m&&E.default.createElement("div",{className:Le.data},E.default.createElement("span",{className:S.label},e),E.default.createElement("div",{"data-testid":"confirmScCall",className:Le.value},[(0,Mt.decodePart)(m),...d].join("@"))),E.default.createElement("div",{className:Le.data},E.default.createElement("span",{className:S.label},t),E.default.createElement("div",{"data-testid":"confirmData",className:Le.value},r?p:"N/A")))};n();n();var re=u(require("react")),qt=require("@terradharitri/sdk-dapp/UI/FormatAmount/FormatAmount");n();var Ia=`:root {
  --primary: #1b46c2;
  --primary-light: #1392ff;
  --border-color: #dee2e6;
  --card-bg: white;
...
.dapp-core-component__styles-module__confirmReceiver .dapp-core-component__styles-module__icon {
  ...
  width: auto;
  top: 1px;
}`;document.head.appendChild(document.createElement("style")).appendChild(document.createTextNode(Fa));var M={confirmReceiver:"dapp-core-component__styles-module__confirmReceiver",value:"dapp-core-component__styles-module__value",shrunk:"dapp-core-component__styles-module__shrunk",subValue:"dapp-core-component__styles-module__subValue",subValueTrim:"dapp-core-component__styles-module__subValueTrim",subValueCopy:"dapp-core-component__styles-module__subValueCopy",explorer:"dapp-core-component__styles-module__explorer",icon:"dapp-core-component__styles-module__icon"};var Qt=({label:t="Receiver",receiver:e,scamReport:r,receiverUsername:o})=>{let i=Boolean(o),p=o!=null?o:e;return G.default.createElement("div",{className:M.confirmReceiver},G.default.createElement("span",{className:S.label},t),G.default.createElement("span",{className:(0,Yt.default)(M.value,{[M.shrunk]:i}),"data-testid":"confirmReceiver"},i&&G.default.createElement(zt,{className:M.icon}),p,i&&G.default.createElement(jt.ExplorerLink,{page:`/${Xt.ACCOUNTS_ENDPOINT}/${e}`,className:M.explorer})),i&&G.default.createElement("span",{className:M.subValue},G.default.createElement(Jt.Trim,{text:e,className:M.subValueTrim}),G.default.createElement(Ht.CopyButton,{text:e,className:M.subValueCopy})),r&&G.default.createElement("div",{className:M.scam},G.default.createElement("span",null,G.default.createElement(Kt.FontAwesomeIcon,{icon:Zt.faExclamationTriangle,className:M.icon}),G.default.createElement("small",{"data-testid":"confirmScamReport"},r))))};n();n();var te=u(require("react"));n();n();var C=u(require("react")),eo=require("@fortawesome/free-solid-svg-icons"),ro=require("@fortawesome/react-fontawesome"),to=u(require("@terradharitri/sdk-dapp/constants/index")),oo=require("@terradharitri/sdk-dapp/UI/FormatAmount/FormatAmount"),no=u(require("classnames"));n();var Pa=`:root {
  --primary: #1b46c2;
  --primary-light: #1392ff;
  --border-color: #dee2e6;
  --card-bg: white;
...
.dapp-core-component__styles-module__token .dapp-core-component__styles-module__label {
  display: block;
}`;document.head.appendChild(document.createElement("style")).appendChild(document.createTextNode(Ba));var io={token:"dapp-core-component__styles-module__token",label:"dapp-core-component__styles-module__label"};var ao=({RewaIcon:t,rewaLabel:e,isDcdtTransaction:r,nft:o,tokenAvatar:i,tokenId:p,tokenIdError:m})=>{var f;let d=(o==null?void 0:o.name)||"";return te.default.createElement("div",{className:io.token},te.default.createElement("span",{className:S.label},o?te.default.createElement("span",null,o==null?void 0:o.name," "):"","Token"),te.default.createElement("div",null,o?te.default.createElement(Gr,{inDropdown:!0,token:{name:o==null?void 0:o.name,identifier:o==null?void 0:o.identifier,decimals:0,balance:v,ticker:"",assets:{svgUrl:((f=o==null?void 0:o.assets)==null?void 0:f.svgUrl)||""}}}):te.default.createElement(Gr,{inDropdown:!0,token:{name:r?d:"DharitrI eGold",identifier:r?p:e,decimals:0,balance:v,ticker:"",assets:{svgUrl:i||""}},isRewa:p===e,RewaIcon:t})),m&&te.default.createElement("div",{className:S.error},m))};var oe=class extends so.Component{render(){return null}};oe.Receiver=Qt,oe.Amount=Vt,oe.Fee=Ot,oe.Data=Rt,oe.Token=ao;var rr=oe;n();n();var Y=u(require("react")),Br=u(require("classnames"));n();var Da=`.dapp-core-component__styles-module__preview {
  border-radius: 8px;
  display: flex;
  align-items: center;
  overflow: hidden;
