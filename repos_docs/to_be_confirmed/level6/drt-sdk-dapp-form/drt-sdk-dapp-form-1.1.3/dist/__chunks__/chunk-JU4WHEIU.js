import{a as F}from"./chunk-5D5FIRQD.js";import{a as T}from"./chunk-UNJGUBOO.js";import{a as w,b as y}from"./chunk-4YTJRQWY.js";import{a as p,b as _,c as V,f as x,i as n}from"./chunk-BL7T5FXS.js";import{f as t}from"./chunk-RGFNPOTZ.js";t();t();n();var R=`.dapp-core-component__tokenSelect-module__label {
  display: none;
}
...
.dapp-core-component__tokenSelect-module__select .dapp-core-component__tokenSelect-module__ticker {
  display: flex;
  align-items: center;
}`;document.head.appendChild(document.createElement("style")).appendChild(document.createTextNode(R));var e={label:"dapp-core-component__tokenSelect-module__label",select:"dapp-core-component__tokenSelect-module__select",disabled:"dapp-core-component__tokenSelect-module__disabled",control:"dapp-core-component__tokenSelect-module__control",indicator:"dapp-core-component__tokenSelect-module__indicator",payload:"dapp-core-component__tokenSelect-module__payload",single:"dapp-core-component__tokenSelect-module__single",container:"dapp-core-component__tokenSelect-module__container",icon:"dapp-core-component__tokenSelect-module__icon",asset:"dapp-core-component__tokenSelect-module__asset",diamond:"dapp-core-component__tokenSelect-module__diamond",wrapper:"dapp-core-component__tokenSelect-module__wrapper",focused:"dapp-core-component__tokenSelect-module__focused",dropdown:"dapp-core-component__tokenSelect-module__dropdown",price:"dapp-core-component__tokenSelect-module__price",expanded:"dapp-core-component__tokenSelect-module__expanded",loading:"dapp-core-component__tokenSelect-module__loading",menu:"dapp-core-component__tokenSelect-module__menu",list:"dapp-core-component__tokenSelect-module__list",option:"dapp-core-component__tokenSelect-module__option",selected:"dapp-core-component__tokenSelect-module__selected",info:"dapp-core-component__tokenSelect-module__info",left:"dapp-core-component__tokenSelect-module__left",right:"dapp-core-component__tokenSelect-module__right",value:"dapp-core-component__tokenSelect-module__value",children:"dapp-core-component__tokenSelect-module__children",ticker:"dapp-core-component__tokenSelect-module__ticker"};import L from"react";import M from"classnames";import{components as O}from"react-select";n();var Ne=o=>L.createElement(O.IndicatorsContainer,_(p({},o),{className:M(e.indicator,{[e.expanded]:o.selectProps.menuIsOpen})}));t();import $ from"react";import{components as q}from"react-select";n();var Ve=o=>$.createElement(q.Input,_(p({},o),{className:e.dropdown,"data-testid":"tokenSelectInput"}));t();import I from"react";import{faCircleNotch as B}from"@fortawesome/free-solid-svg-icons";import{FontAwesomeIcon as W}from"@fortawesome/react-fontawesome";import{components as X}from"react-select";n();var Me=o=>I.createElement(X.Menu,_(p({},o),{className:e.menu}),o.selectProps.isLoading?I.createElement("div",{className:e.loading},I.createElement(W,{icon:B,className:"fa-spin",size:"lg"})):o.children);t();import Z from"react";import{components as G}from"react-select";n();var Xe=o=>{let m=o,{rx:s}=m,a=V(m,["rx"]);return Z.createElement(G.MenuList,_(p({},a),{className:e.list}))};t();import H from"react";import J from"classnames";import{components as K}from"react-select";n();var Ye=o=>H.createElement(K.Placeholder,_(p({},o),{className:J(e.placeholder,{[e.focused]:o.isFocused})}));t();import Q from"react";import{components as Y}from"react-select";n();var po=o=>Q.createElement(Y.Control,_(p({},o),{className:e.control}));t();import c from"react";import{faDiamond as ee}from"@fortawesome/free-solid-svg-icons";import{FontAwesomeIcon as oe}from"@fortawesome/react-fontawesome";import{DECIMALS as te}from"@terradharitri/sdk-dapp/constants";import{UsdValue as ne}from"@terradharitri/sdk-dapp/UI/UsdValue";import{getIdentifierType as ce}from"@terradharitri/sdk-dapp/utils/validation/getIdentifierType";import pe from"classnames";import{components as _e}from"react-select";n();var{default:le}=(y(),x(w)),vo=({RewaIcon:o,TokenTickerIcon:m,showBalanceUsdValue:s,showTokenPrice:a})=>d=>{var f,g,h,b;let{data:l,isSelected:E,isFocused:N,isDisabled:v,selectProps:z}=d,i=l,{isRewa:U}=ce(i.value),C=i.token.assets?i.token.assets.svgUrl:null,j=T({amount:i.token.balance,decimals:i.token.decimals||te,addCommas:!0}),A=(g=(f=i.token)==null?void 0:f.usdPrice)==null?void 0:g.toString(),D=(b=(h=i.token)==null?void 0:h.valueUSD)==null?void 0:b.toString();return c.createElement("div",{"data-testid":`${d.value}-option`},c.createElement(_e.Option,_(p({},d),{className:pe(e.option,{[e.selected]:E||N,[e.disabled]:v})}),c.createElement("div",{className:e.image},U?c.createElement("span",{className:e.icon},o?c.createElement(o,null):c.createElement(le,null)):C?c.createElement("img",{src:C,className:e.icon}):c.createElement("span",{className:e.icon},c.createElement(oe,{icon:ee,className:e.diamond}))),c.createElement("div",{className:e.info},c.createElement("div",{className:e.left},c.createElement("div",{className:e.ticker},c.createElement("span",{className:e.value},z.inputValue?c.createElement(F,{text:i.token.ticker,highlight:z.inputValue}):i.token.ticker),m&&c.createElement(m,{token:i.token})),a&&c.createElement("small",{className:e.price},A)),c.createElement("div",{className:e.right},c.createElement("span",{className:e.value},j),s&&D&&c.createElement(ne,{usd:1,decimals:4,amount:D,"data-testid":"token-price-usd-value",className:e.price,addEqualSign:!1}))),c.createElement("div",{className:e.children},d.children)))};t();import P from"react";import me from"classnames";import{components as re}from"react-select";n();var Po=o=>m=>{let{selectProps:s,children:a}=m,d=s.value;return P.createElement(re.SingleValue,_(p({},m),{className:me(e.single,{[e.focused]:m.selectProps.menuIsOpen})}),P.createElement("div",{className:e.ticker},a,o&&P.createElement(o,{token:d==null?void 0:d.token})))};t();import r,{useMemo as ae}from"react";import{faDiamond as de}from"@fortawesome/free-solid-svg-icons";import{FontAwesomeIcon as ie}from"@fortawesome/react-fontawesome";import{getIdentifierType as se}from"@terradharitri/sdk-dapp/utils/validation/getIdentifierType";import ue from"classnames";import{components as ke}from"react-select";n();var Se=(y(),x(w)).default,fe=({RewaIcon:o,tokenId:m,icon:s})=>{let{isRewa:a}=se(m);return a?r.createElement("span",{className:e.asset},o?r.createElement(o,{className:e.diamond}):r.createElement(Se,{className:e.diamond})):s?r.createElement("img",{src:s,className:e.asset}):r.createElement(ie,{icon:de,className:e.asset})},ge=({children:o})=>r.createElement("div",{className:e.wrapper},o),Lo=(o,m,s)=>a=>{var d,f;let{selectProps:g,isDisabled:h,children:b}=a,l=g.value,E=(f=(d=l==null?void 0:l.assets)==null?void 0:d.svgUrl)!=null?f:null,N=ae(()=>{let v=String(l==null?void 0:l.token.usdPrice);return v!=null&&v.includes("$")?l==null?void 0:l.token.usdPrice:`$${l==null?void 0:l.token.usdPrice}`},[l==null?void 0:l.token.usdPrice]);return r.createElement(ke.ValueContainer,_(p({},a),{className:e.container}),r.createElement("div",{className:ue(e.icon,m)},r.createElement(fe,{RewaIcon:s,rewaLabel:o,icon:E,isDisabled:h,tokenId:l==null?void 0:l.value})),r.createElement("div",{className:e.payload},r.createElement(ge,null,b,(l==null?void 0:l.token.usdPrice)&&r.createElement("small",{className:e.price},N))))};export{e as a,Ne as b,Ve as c,Me as d,Xe as e,Ye as f,po as g,le as h,vo as i,Po as j,fe as k,Lo as l};
//# sourceMappingURL=chunk-JU4WHEIU.js.map
