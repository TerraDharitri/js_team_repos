import{a as s}from"./chunk-OYOVQKX5.js";import{c as r,i as p}from"./chunk-P4IVSQC4.js";import{f as n}from"./chunk-JH2LJGTQ.js";n();n();p();var h=`.dapp-core-component__styles-module__preview {
  border-radius: 8px;
  display: flex;
  align-items: center;
  overflow: hidden;
...
}`;document.head.appendChild(document.createElement("style")).appendChild(document.createTextNode(h));var e={preview:"dapp-core-component__styles-module__preview",clickable:"dapp-core-component__styles-module__clickable",image:"dapp-core-component__styles-module__image",content:"dapp-core-component__styles-module__content",left:"dapp-core-component__styles-module__left",name:"dapp-core-component__styles-module__name",identifier:"dapp-core-component__styles-module__identifier",badge:"dapp-core-component__styles-module__badge",nft:"dapp-core-component__styles-module__nft",sft:"dapp-core-component__styles-module__sft"};import o from"react";import m from"classnames";p();var z=i=>{let d=i,{txType:t,onClick:_,identifier:a}=d,l=r(d,["txType","onClick","identifier"]),{name:u,thumbnail:f}=s({nft:l}),y=["NonFungibleDCDT","SemiFungibleDCDT"].includes(t),g=t==="NonFungibleDCDT"?"NFT":"SFT",b=c=>{c.preventDefault(),_&&_(c,Object.assign(l,{identifier:a}))};return y?o.createElement("div",{onClick:b,"data-testid":"token-preview",className:m(e.preview,{[e.clickable]:Boolean(_)})},o.createElement("img",{src:f,className:e.image}),o.createElement("div",{className:e.content},o.createElement("div",{className:e.left},o.createElement("div",{"data-testid":"token-preview-name",className:e.name},u),o.createElement("div",{"data-testid":"token-preview-identifier",className:e.identifier},a)),o.createElement("div",{className:e.right},o.createElement("div",{className:m(e.badge,{[e.nft]:t==="NonFungibleDCDT",[e.sft]:t==="SemiFungibleDCDT"})},g)))):null};export{z as a};
//# sourceMappingURL=chunk-PHEERNT7.js.map
