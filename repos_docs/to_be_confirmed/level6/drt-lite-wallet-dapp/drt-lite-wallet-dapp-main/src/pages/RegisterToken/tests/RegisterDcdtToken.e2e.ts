import { sleep } from '@terradharitri/sdk-dapp-core';
import {
...
describe('Register DCDT Token test', () => {
  it('should register an DCDT token from sovereign to testnet successfully', async () => {
    ...
    await expectToBeChecked({
      dataTestId: DataTestIdsEnum.sendDcdtTypeInput,
      isChecked: true
    });
