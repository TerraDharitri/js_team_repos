export const Disclaimer = () => {
  return (
    <div className='prose-sm drt-auto max-w-prose'>
      ...
      <div className='flex flex-col gap-4'>
        <p>
          ...
          or written or electronically delivered information given by DharitrI
        ...
        <p>
          In no event shall DharitrI be liable for any injury, expenses, lost
