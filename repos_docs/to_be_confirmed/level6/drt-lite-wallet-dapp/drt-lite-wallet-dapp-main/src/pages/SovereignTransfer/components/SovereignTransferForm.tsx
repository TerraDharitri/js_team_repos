  ...
  return (
    <form onSubmit={formik.handleSubmit}>
                  ...
                  <div className='flex flex-row gap-4'>
                    <div>
                      <input
                        checked={!isNFT}
                        className='mr-2'
                        data-testid={`${DataTestIdsEnum.sendDcdtTypeInput}${index}`}
                        id={`${SendTypeEnum.dcdt}${index}`}
                        name={typeFieldName}
                        onChange={handleOnSendTypeChange(SendTypeEnum.dcdt)}
                        type='radio'
                        value={SendTypeEnum.dcdt}
                      />
                      <label htmlFor={SendTypeEnum.dcdt} className='text-sm'>
                        {SendTypeEnum.dcdt}
                      </label>
                    </div>
                    <div>
      ...
      <div className='mt-4 flex flex-col align-middle'>
        <Button
          className='mt-4 drt-auto rounded-lg bg-blue-600 px-4 py-2 text-white'
