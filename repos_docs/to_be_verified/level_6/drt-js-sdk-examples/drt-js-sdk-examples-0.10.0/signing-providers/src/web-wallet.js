import { Address, AddressComputer, ApiNetworkProvider, Message, Transaction, TransactionPayload } from "@terradharitri/sdk-core";
...
export class WebWallet {
    constructor() {
        ...
        this.apiNetworkProvider = new ApiNetworkProvider(API_URL, { clientName: "dharitri-sdk-js-examples" });
        this._address = "";
    }
    ...
    async signTransaction() {
        ...
        const transaction = new Transaction({
            ...
            receiver: new Address("drt1uv40ahysflse896x4ktnh6ecx43u7cmy9wnxnvcyp7deg299a4sq8s28dr"),
            gasPrice: 1000000000,
            gasLimit: 50000,
    ...
    async signRelayedTransaction() {
        ...
        const relayer = {
            // https://github.com/TerraDharitri/drt-sdk-testwallets/blob/main/users/mike.pem
            0: "drt1uv40ahysflse896x4ktnh6ecx43u7cmy9wnxnvcyp7deg299a4sq8s28dr",
            // https://github.com/TerraDharitri/drt-sdk-testwallets/blob/main/users/grace.pem
            1: "drt1r69gk66fmedhhcg24g2c5kn2f2a5k4kvpr6jfw67dn2lyydd8cfsncd6w8",
            // https://github.com/TerraDharitri/drt-sdk-testwallets/blob/main/users/carol.pem
            2: "drt1k2s324ww2g0yj38qn2ch2jwctdy8mnfxep94q9arncc6xecg3xaq889n6e"
        }[senderShard];
        ...
        const transaction = new Transaction({
            ...
            receiver: Address.newFromBech32("drt1testnlersh4z0wsv8kjx39me4rmnvjkwu8dsaea7ukdvvc9z396qe2mapq"),
