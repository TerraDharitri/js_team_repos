...
// Generally speaking, in order to create transactions that transfer native tokens or DCDT tokens, one should use the `class:TransferTransactionsFactory` class.
//
// :::note
