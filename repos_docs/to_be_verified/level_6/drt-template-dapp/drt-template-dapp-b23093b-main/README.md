# @terradharitri/template-dapp

The **Dharitri dApp Template**, built using [React.js](https://reactjs.org/) and [Typescript](https://www.typescriptlang.org/).
It's a basic implementation of [@terradharitri/sdk-dapp](https://www.npmjs.com/package/@terradharitri/sdk-dapp), providing the basics for Dharitri authentication and TX signing.

See [Dapp template](https://template-dapp.dharitri.org/) for live demo.
