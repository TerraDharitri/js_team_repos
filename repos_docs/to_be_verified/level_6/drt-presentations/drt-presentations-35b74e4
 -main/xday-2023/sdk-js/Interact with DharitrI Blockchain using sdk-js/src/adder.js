...
const { Address, SmartContract, BigUIntValue, BinaryCodec, BigUIntType } = require("@terradharitri/sdk-core");
const { ContractAppBase } = require("./shared");
const { CHAIN_ID } = require("./config");

// Contract: https://github.com/TerraDharitri/drt-sdk-rs/blob/master/contracts/examples/adder/src/adder.rs.
// Built bytecode: https://github.com/TerraDharitri/drt-reproducible-contract-build-example-sc/releases/download/v0.4.3/adder.wasm.
