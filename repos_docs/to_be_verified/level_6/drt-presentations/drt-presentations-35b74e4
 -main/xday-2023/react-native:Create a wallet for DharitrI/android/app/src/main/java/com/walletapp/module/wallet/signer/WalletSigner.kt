...
import wallet.core.jni.proto.DharitrI

object WalletSigner {
    fun signTransaction(privateKey: PrivateKey, transaction: SignTransactionInput): String {
        val accountsBuilder = DharitrI.Accounts.newBuilder()
        ...
        val genericActionBuilder = DharitrI.GenericAction.newBuilder()
        ...
        val signingInput = DharitrI.SigningInput.newBuilder()
        ...
        val signerOutput = AnySigner.sign(signingInput.build(), CoinType.DHARITRI, DharitrI.SigningOutput.parser())
    ...
    private const val MESSAGE_PREFIX = "\u0017Numbat Signed Message:\n"
