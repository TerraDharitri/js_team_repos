...
import { useGetDharitriTransactionByHashQuery } from 'reduxStore/apis/root.api';
import { useNavigation, useRoute } from '@react-navigation/native';
import { formatAmount } from '@terradharitri/sdk-dapp/utils/operations/formatAmount';
import { DECIMALS } from '@terradharitri/sdk-dapp/constants';
...
const TransactionStatusScreen = () => {
  ...
  const {
    ...
    isLoading,
    error
  } = useGetDharitriTransactionByHashQuery(txHash);
      ...
      <>
        ...
        <View>
          <View style={styles.rowWrapper}>
            ...
            <Text style={styles.amount}>{formattedAmount} XrEWA</Text>
          </View>
          <View style={styles.rowWrapper}>
