...
describe('Sovereign transfer test', () => {
  it('should transfer DCDT and NFT tokens on sovereign successfully', async () => {
    ...
    await expectToBeChecked({
      dataTestId: `${DataTestIdsEnum.sendDcdtTypeInput}0`,
      isChecked: true
    });
    ...
    await expectToBeChecked({
      dataTestId: `${DataTestIdsEnum.sendDcdtTypeInput}1`,
      isChecked: true
    });
    ...
    await page.click(getByDataTestId(DataTestIdsEnum.addTokenBtn));
    await expectToBeChecked({
      dataTestId: `${DataTestIdsEnum.sendDcdtTypeInput}2`,
      isChecked: true
    });
    ...
    await page.click(getByDataTestId(DataTestIdsEnum.addTokenBtn));
    await expectToBeChecked({
      dataTestId: `${DataTestIdsEnum.sendDcdtTypeInput}3`,
      isChecked: true
    });
