...
const WIDGETS: WidgetType[] = [
  {
    ...
    reference: 'https://docs.dharitri.org/sdk-and-tools/sdk-dapp/#account'
  },
  {
    ...
    reference:
      'https://docs.dharitri.org/sdk-and-tools/indices/es-index-transactions/',
  ...
  },
  {
    ...
    reference:
      'https://docs.dharitri.org/sdk-and-tools/sdk-js/sdk-js-cookbook/#using-interaction-when-the-abi-is-available',
  ...
  },
  {
    ...
    reference: 'https://docs.dharitri.org/sdk-and-tools/sdk-dapp/#account-1',
    anchor: 'sign-message'
  },
  {
    title: 'Native auth',
