import { Address, Message, Transaction, TransactionPayload } from "@terradharitri/sdk-core";
...
export class Webview {
    ...
    async signMessage() {
        const message = new Message({
            address: new Address("drt1uv40ahysflse896x4ktnh6ecx43u7cmy9wnxnvcyp7deg299a4sq8s28dr"),
