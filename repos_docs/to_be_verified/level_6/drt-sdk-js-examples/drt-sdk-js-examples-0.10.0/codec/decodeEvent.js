import { AbiRegistry, ApiNetworkProvider, ResultsParser } from "@terradharitri/sdk-core";
...
async function main() {
    ...
    const provider = new ApiNetworkProvider(apiUrl, { clientName: "dharitri-sdk-js-examples" });
