...
export enum TRANSACTION_EVENTS {
    DCDT_NFT_Transfer = 'DCDTNFTTransfer',
    DCDT_NFT_Burn = 'DCDTNFTBurn',
    DCDT_NFT_ADD_QUANTITY = 'DCDTNFTAddQuantity',
    DCDT_NFT_CREATE = 'DCDTNFTCreate',
    MULTI_DCDT_NFT_TRANSFER = 'MultiDCDTNFTTransfer',
    DCDT_TRANSFER = 'DCDTTransfer',
    DCDT_BURN = 'DCDTBurn',
    DCDT_LOCAL_MINT = 'DCDTLocalMint',
    DCDT_LOCAL_BURN = 'DCDTLocalBurn',
    DCDT_WIPE = 'DCDTWipe',
    DCDT_FREEZE = 'DCDTFreeze',
