...
export class TokenSetterService extends GenericSetterService {
    ...
    async setTokenMetadata(tokenID: string, value: DcdtToken): Promise<string> {
    ...
    async setDcdtTokenType(tokenID: string, type: string): Promise<string> {
        return await this.setDataOrUpdateTtl(
            this.getTokenCacheKey(tokenID, 'getDcdtTokenType'),
            type,
            CacheTtlInfo.Token.remoteTtl,
            CacheTtlInfo.Token.localTtl,
        );
    ...
    async setMetadata(tokenID: string, value: DcdtToken): Promise<string> {
        return await this.setData(
    ...
    async setBaseMetadata(tokenID: string, value: DcdtToken): Promise<string> {
        return await this.setData(
