    ...
    constructor() {
        super({
            description: new DescriptionV1({
                ...
                shortDescription:
                    'DharitriX (Durian DEX 2.0) presents a set of significant improvements and benefits, while correcting the most important limitations residing in the previous economics model.',
                strapiId: 2,
                version: 1,
            }),
