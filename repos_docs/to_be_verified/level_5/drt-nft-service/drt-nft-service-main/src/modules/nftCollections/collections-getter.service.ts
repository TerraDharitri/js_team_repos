...
import { ElasticQuery, QueryType, ElasticSortOrder } from '@terradharitri/sdk-nestjs-elastic';
...
export class CollectionsGetterService {
  ...
  private getCollectionQuery(): ElasticQuery {
    return ElasticQuery.create()
      ...
      .withMustMultiShouldCondition([NftTypeEnum.NonFungibleDCDT, NftTypeEnum.SemiFungibleDCDT], (type) => QueryType.Match('type', type))
