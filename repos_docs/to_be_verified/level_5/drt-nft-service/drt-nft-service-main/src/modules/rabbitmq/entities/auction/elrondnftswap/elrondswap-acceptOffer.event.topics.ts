import { Address, BinaryCodec, FieldDefinition, StructType, TokenIdentifierType, U64Type } from '@terradharitri/sdk-core/out';

export class NumbatSwapAcceptOfferTopics {
...
function decodeToken(bufer: Buffer): any {
  ...
  const type = new StructType('DcdtToken', [
