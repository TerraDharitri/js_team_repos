...
export const REWA_OR_DCDT_TOKEN_RGX = '(REWA)|(^[A-Z0-9]{3,10}-[a-f0-9]{6}$)';
export const DCDT_TOKEN_ERROR = 'You should provide a valid DCDT token identifier';
export const ADDRESS_RGX = '^drt[a-z0-9]{59,59}$';
export const ADDRESS_ERROR = 'You should provide a valid drt address';
