    ...
    for (let event of mintEvents) {
      switch (event.identifier) {
        case NftEventEnum.DCDTNFTCreate:
          ...
          const collection =
            await this.drtApiService.getCollectionByIdentifierForQuery(
              createTopics.collection,
              'fields=name,type',
            );
          if (
            collection?.type === NftTypeEnum.NonFungibleDCDT ||
            collection?.type === NftTypeEnum.SemiFungibleDCDT
          ) {
        ...
        case NftEventEnum.DCDTNFTTransfer:
          ...
          if (
            collectionInfo?.type === NftTypeEnum.NonFungibleDCDT ||
            collectionInfo?.type === NftTypeEnum.SemiFungibleDCDT
          ) {
        ...
        case NftEventEnum.DCDTNFTBurn:
          ...
          if (
            burnCollection?.type === NftTypeEnum.NonFungibleDCDT ||
            burnCollection?.type === NftTypeEnum.SemiFungibleDCDT
          ) {
        ...
        case NftEventEnum.MultiDCDTNFTTransfer:
          ...
          if (
            collectionDetails?.type === NftTypeEnum.NonFungibleDCDT ||
            collectionDetails?.type === NftTypeEnum.SemiFungibleDCDT
          ) {
