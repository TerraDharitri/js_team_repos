      ...
      await this.nftEventsService.handleNftMintEvents(
        nftAuctionEvents?.events?.filter(
          (e: { identifier: NftEventEnum }) =>
            e.identifier === NftEventEnum.DCDTNFTCreate ||
            e.identifier === NftEventEnum.DCDTNFTTransfer ||
            e.identifier === NftEventEnum.DCDTNFTBurn ||
            e.identifier === NftEventEnum.MultiDCDTNFTTransfer,
        ),
