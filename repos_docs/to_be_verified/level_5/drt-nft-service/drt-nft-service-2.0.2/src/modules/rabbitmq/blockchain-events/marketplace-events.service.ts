  ...
  public async handleNftAuctionEvents(
    ...
    for (let event of auctionEvents) {
      switch (event.identifier) {
        ...
        case NumbatNftsSwapAuctionEventEnum.Bid:
        ...
        case NumbatNftsSwapAuctionEventEnum.Purchase:
          ...
          if (
            ...
            eventName === NumbatNftsSwapAuctionEventEnum.UpdateListing
          ) {
            this.logger.log(
        ...
        case AuctionEventEnum.WithdrawOffer:
          ...
          break;
        case NumbatNftsSwapAuctionEventEnum.NftSwapUpdate:
        case NumbatNftsSwapAuctionEventEnum.NftSwapExtend:
