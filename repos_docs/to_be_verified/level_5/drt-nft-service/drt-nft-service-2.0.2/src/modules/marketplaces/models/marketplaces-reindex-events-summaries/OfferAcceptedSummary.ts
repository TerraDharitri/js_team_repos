...
import { NumbatNftsSwapAuctionEventEnum } from 'src/modules/assets/models';
...
import { NumbatSwapAcceptOfferEvent } from 'src/modules/rabbitmq/entities/auction/numbatnftswap/numbatswap-acceptOffer.event';
...
export class OfferAcceptedSummary extends ReindexGenericSummary {
  ...
  private static getTopics(
    ...
    if (marketplace.key === NUMBATNFTSWAP_KEY) {
      return new NumbatSwapAcceptOfferEvent(genericEvent).getTopics();
    }
