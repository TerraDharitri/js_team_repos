...
import { NumbatSwapBidEvent } from 'src/modules/rabbitmq/entities/auction/numbatnftswap/numbatswap-bid.event';
...
export class AuctionBidSummary extends ReindexGenericSummary {
  ...
  private static getTopics(
    ...
    if (marketplaceKey === NUMBATNFTSWAP_KEY) {
      return new NumbatSwapBidEvent(genericEvent).getTopics();
    }
