...
import { ITransactionEvent, ResultsParser } from '@terradharitri/sdk-core/out';
import { EventDefinition } from '@terradharitri/sdk-core/out/smartcontracts/typesystem/event';
