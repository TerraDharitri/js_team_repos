...
const one = {
  data: removeWhiteSpaces(`MultiDCDTNFTTransfer@0000000000000000050074b70610036a10129194f8474f2f63e49e3f20ce7ceb
  @03
  @57524557412d376662623930@@1bc16d674ec80000
  @4c4b4d4f412d636661313364@0243@ed1ba6a961f087c4cc
  ...
  dcdt: {
    ...
    data: '57524557412d376662623930@@1bc16d674ec80000',
    receiver:
  ...
  sft1: {
    ...
    token: 'LKMOA-cfa13d',
    data: '4c4b4d4f412d636661313364@0243@ed1ba6a961f087c4cc',
    nonce: '0243',
    receiver:
      '0000000000000000050074b70610036a10129194f8474f2f63e49e3f20ce7ceb',
    type: 'nftTransaction'
...
const two = {
  data: removeWhiteSpaces(`MultiDCDTNFTTransfer@0000000000000000050023a2823d0afcea4373192e362c285287a6bb10c47ceb
  @02
  @57524557412d376662623930@@016345785d8a0000
  @425553442d363631303635@@01511107c5a79fa8da
  @6164644c6971756964697479@015fb7f9b8c38000@014db223dab7de101f`),
  dcdt1: {
    type: 'dcdtTransaction',
    data: '57524557412d376662623930@@016345785d8a0000',
    receiver:
...
describe('parseMultiDcdtTransferData tests', () => {
  test('Interprets data with scCall', () => {
    ...
    const result = parseMultiDcdtTransferData(one.data);
    expect(result).toEqual(response);
  });
  test('Interprets data without scCall', () => {
    const response = [one.dcdt, one.sft1, one.sft2];
    const result = parseMultiDcdtTransferData(
  ...
  test('Fails if format is wrong', () => {
    const result = parseMultiDcdtTransferData(
      'MultiDCDTNFTTransfer@0000000000000000050074b70610036a10129194f8474f2f63e49e3f20ce7ceb@03@'
    );
    expect(result).toEqual([]);
  });
  test('Interprets data with two DCDT transactions', () => {
    const response = [two.dcdt1, two.dcdt2, two.scCall];
    const result = parseMultiDcdtTransferData(two.data);
    expect(result).toEqual(response);
  });
  test('Interprets data with two DCDT and NFT transactions', () => {
  ...
  test('Interprets data with two identical NFT transactions', () => {
    const result = parseMultiDcdtTransferData(
      'MultiDCDTNFTTransfer@000000000000000005006704c51b25a956ddbc643189ba7945b413890d4f0fd6@02@444d452d626465326238@01@01@444d452d626465326238@01@01@6e6674446973747269627574696f6e@ee62513ef30aede25b3366b6e3219ee18084026f36d6105299ee9963b1338f09@ee62513ef30aede25b3366b6e3219ee18084026f36d6105299ee9963b1338f09'
    );
