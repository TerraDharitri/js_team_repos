Unified REST API facade for providing data related to the Dharitri blockchain.
...
- dharitrix: provides price information regarding various tokens listed on the DharitriX
