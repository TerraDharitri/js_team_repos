...
import { DcdtSupply } from "../dcdt/entities/dcdt.supply";
...
import { ParseAddressPipe, ParseBlockHashPipe, ParseBoolPipe, ParseEnumPipe, ParseIntPipe, ParseArrayPipe, ParseTokenPipe, ParseAddressArrayPipe, ApplyComplexity, ParseEnumArrayPipe } from "@terradharitri/sdk-nestjs-common";
...
export class TokenController {
  ...
  async getTokens(
    ...
    return await this.tokenService.getTokens(
      ...
      new TokenFilter({ type, search, name, identifier, identifiers, includeMetaDCDT, sort, order, moaPairType, priceSource })
    );
  }
  ...
  async getTokenCount(
    ...
    return await this.tokenService.getTokenCount(new TokenFilter({ type, search, name, identifier, identifiers, includeMetaDCDT, moaPairType, priceSource }));
  }
