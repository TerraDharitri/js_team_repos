...
describe('Accounts e2e tests with chain simulator', () => {
  ...
  describe('GET /accounts/:address/tokens', () => {
    ...
    it('should filter tokens by type', async () => {
      const response = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/tokens?type=FungibleDCDT`);
      expect(response.status).toBe(200);

      for (const token of response.data) {
        expect(token.type).toBe('FungibleDCDT');
      }
    });
  ...
  describe('GET /accounts/:address/tokens/count', () => {
    ...
    it('should filter tokens by type', async () => {
      const response = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/tokens/count?type=FungibleDCDT`);
      expect(response.status).toBe(200);
  ...
  describe('GET /accounts/:address/roles/collections/count', () => {
    ...
    it('should return results by type parameter', async () => {
      const response = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/roles/collections/count?type=NonFungibleDCDT`);
      expect(response.status).toBe(200);
      expect(response.data).toBeGreaterThanOrEqual(1);
    });
    ...
    it('should return results by excludeMetaDCDT parameter', async () => {
      const response = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/roles/collections/count?excludeMetaDCDT=true`);
      expect(response.status).toBe(200);
      expect(response.data).toBeGreaterThanOrEqual(1);
    });
  });
  ...
  describe('GET /accounts/:address/dcdthistory', () => {
    it('should return account dcdt history for a given address', async () => {
      const response = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/dcdthistory`);
      expect(response.status).toBe(200);
      expect(response.data.length).toBeGreaterThanOrEqual(1);
    });

    it('should return paginated results with from and size parameters', async () => {
      const response = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/dcdthistory?from=0&size=1`);
      expect(response.status).toBe(200);
      expect(response.data.length).toBeLessThanOrEqual(1);
    });
    ...
    it('should return results with token parameter', async () => {
      const tokens = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/tokens`);
      const tokenIdentifier = tokens.data[0].identifier;
      const response = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/dcdthistory?token=${tokenIdentifier}`);
      expect(response.status).toBe(200);
      expect(response.data.length).toStrictEqual(1);
    });
  });

  describe('GET /accounts/:address/dcdthistory/count', () => {
    it('should return the total number of account dcdt history for a given address', async () => {
      const response = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/dcdthistory/count`);
      expect(response.status).toBe(200);
      expect(typeof response.data).toBe('number');
      expect(response.data).toBeGreaterThanOrEqual(1);
    });

    it('should return the total number of account dcdt history for a given address and token identifier', async () => {
      const tokens = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/tokens`);
      const tokenIdentifier = tokens.data[0].identifier;
      const response = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/dcdthistory/count?token=${tokenIdentifier}`);
      expect(response.status).toBe(200);
      expect(typeof response.data).toBe('number');
      expect(response.data).toStrictEqual(1);
    });
  ...
  describe('GET /accounts/:address/transfers', () => {
    ...
    it('should return transfers with token parameter', async () => {
      ...
      for (const transfer of response.data) {
        ...
        expect(transfer.function).toBe('DCDTTransfer');
      }
    });
  ...
  describe('GET /accounts/:address/nfts', () => {
    ...
    it('should return accounts nfts filtered by type parameter', async () => {
      const response = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/nfts?type=${NftType.NonFungibleDCDT}`);
      expect(response.status).toBe(200);

      for (const nft of response.data) {
        expect(nft.type).toStrictEqual(NftType.NonFungibleDCDT);
      }
    });

    it('should return accounts sfts filtered by type parameter', async () => {
      const response = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/nfts?type=${NftType.SemiFungibleDCDT}`);
      expect(response.status).toBe(200);

      for (const nft of response.data) {
        expect(nft.type).toStrictEqual(NftType.SemiFungibleDCDT);
      }
    });

    it('should return accounts MetaDCDTs filtered by type parameter', async () => {
      const response = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/nfts?type=${NftType.MetaDCDT}`);
      expect(response.status).toBe(200);

      for (const nft of response.data) {
        expect(nft.type).toStrictEqual(NftType.MetaDCDT);
      }
    });

    it('should return accounts nftsV2 filtered by subType parameter', async () => {
      const response = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/nfts?subType=${NftSubType.NonFungibleDCDTv2}`);
      expect(response.status).toBe(200);

      for (const nft of response.data) {
        expect(nft.subType).toStrictEqual(NftSubType.NonFungibleDCDTv2);
      }
    });

    it('should return accounts sft filtered by subType parameter', async () => {
      const response = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/nfts?subType=${NftSubType.SemiFungibleDCDT}`);
      expect(response.status).toBe(200);

      for (const nft of response.data) {
        expect(nft.subType).toStrictEqual(NftSubType.SemiFungibleDCDT);
      }
    });

    it('should return accounts MetaDCDTs filtered by subType parameter', async () => {
      const response = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/nfts?subType=${NftSubType.MetaDCDT}`);
      expect(response.status).toBe(200);

      for (const nft of response.data) {
        expect(nft.subType).toStrictEqual(NftSubType.MetaDCDT);
      }
    });
    ...
    it('should return acoount SFT filtered by withSupply parameter', async () => {
      const response = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/nfts?withSupply=true&type=${NftType.SemiFungibleDCDT}`);
      expect(response.status).toBe(200);
    ...
    it('should return acoount NFT filtered by withSupply parameter', async () => {
      const response = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/nfts?withSupply=true&type=${NftType.NonFungibleDCDT}`);
      expect(response.status).toBe(200);
    ...
    it('should return acoount MetaDCDT filtered by withSupply parameter', async () => {
      const response = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/nfts?withSupply=true&type=${NftType.MetaDCDT}`);
      expect(response.status).toBe(200);
    ...
    it('should return accounts nfts without MetaDCDTs', async () => {
      const response = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/nfts?excludeMetaDCDT=true`);
      expect(response.status).toBe(200);

      for (const nft of response.data) {
        expect(nft.type).not.toStrictEqual(NftType.MetaDCDT);
      }

      expect(response.data.every((nft: any) =>
        [NftType.NonFungibleDCDT, NftType.SemiFungibleDCDT].includes(nft.type)
      )).toBe(true);
    });
  });
  ...
  describe('GET /accounts/:address/nfts/count', () => {
    ...
    it('should return the total number of nfts for a given address filtered by search parameter', async () => {
      const accountNfts = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/nfts?size=1&type=${NftType.NonFungibleDCDT}`);
      const nft = accountNfts.data[0];
    ...
    it('should return the total number of nfts for a given address filtered by type parameter', async () => {
      const response = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/nfts/count?type=${NftType.NonFungibleDCDT}`);
      expect(response.status).toBe(200);
    ...
    it('should return the total number of sfts for a given address filtered by type parameter', async () => {
      const response = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/nfts/count?type=${NftType.SemiFungibleDCDT}`);
      expect(response.status).toBe(200);
      expect(response.data).toStrictEqual(10);
    });

    it('should return the total number of metadcdt  for a given address filtered by type parameter', async () => {
      const response = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/nfts/count?type=${NftType.MetaDCDT}`);
      expect(response.status).toBe(200);
      expect(response.data).toStrictEqual(10);
    });

    it('should return the total number of nfts for a given address filtered by subType parameter', async () => {
      const response = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/nfts/count?subType=${NftSubType.NonFungibleDCDTv2}`);
      expect(response.status).toBe(200);
      expect(response.data).toStrictEqual(10);
    });

    it('should return the total number of sfts for a given address filtered by subType parameter', async () => {
      const response = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/nfts/count?subType=${NftSubType.SemiFungibleDCDT}`);
      expect(response.status).toBe(200);
      expect(response.data).toStrictEqual(10);
    });

    it('should return the total number of metadcdt for a given address filtered by subType parameter', async () => {
      const response = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/nfts/count?subType=${NftSubType.MetaDCDT}`);
      expect(response.status).toBe(200);
      expect(response.data).toStrictEqual(10);
    });
  ...
  describe('GET /accounts/:address/nfts/c alternative', () => {
    ...
    it('should return the total number of nfts for a given address filtered by search parameter', async () => {
      const accountNfts = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/nfts?size=2&type=${NftType.NonFungibleDCDT}`);
      const nft = accountNfts.data[0];
    ...
    it('should return the total number of nfts for a given address filtered by type parameter', async () => {
      const response = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/nfts/c?type=${NftType.NonFungibleDCDT}`);
      expect(response.status).toBe(200);
      expect(response.data).toStrictEqual(10);
    });

    it('should return the total number of sfts for a given address filtered by type parameter', async () => {
      const response = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/nfts/c?type=${NftType.SemiFungibleDCDT}`);
      expect(response.status).toBe(200);
      expect(response.data).toStrictEqual(10);
    });

    it('should return the total number of metadcdt  for a given address filtered by type parameter', async () => {
      const response = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/nfts/c?type=${NftType.MetaDCDT}`);
      expect(response.status).toBe(200);
      expect(response.data).toStrictEqual(10);
    });

    it('should return the total number of nfts for a given address filtered by subType parameter', async () => {
      const response = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/nfts/c?subType=${NftSubType.NonFungibleDCDTv2}`);
      expect(response.status).toBe(200);
      expect(response.data).toStrictEqual(10);
    });

    it('should return the total number of sfts for a given address filtered by subType parameter', async () => {
      const response = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/nfts/c?subType=${NftSubType.SemiFungibleDCDT}`);
      expect(response.status).toBe(200);
      expect(response.data).toStrictEqual(10);
    });

    it('should return the total number of metadcdt for a given address filtered by subType parameter', async () => {
      const response = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/nfts/c?subType=${NftSubType.MetaDCDT}`);
      expect(response.status).toBe(200);
      expect(response.data).toStrictEqual(10);
    });
  ...
  describe('GET /accounts/:address/nfts/:nft', () => {
    ...
    it('should return the MetaDCDT details with the proper fields', async () => {
      const accountNfts = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/nfts?size=1&type=${NftType.MetaDCDT}`);
      const nft = accountNfts.data[0];
    ...
    it('should return the NonFungibleDCDT details with the proper fields', async () => {
      const accountNfts = await axios.get(`${config.apiServiceUrl}/accounts/${config.aliceAddress}/nfts?size=1&type=${NftType.NonFungibleDCDT}`);
      const nft = accountNfts.data[0];
