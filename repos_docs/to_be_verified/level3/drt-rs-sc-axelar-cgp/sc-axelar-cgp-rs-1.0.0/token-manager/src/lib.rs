    ...
    + mintership::Mintership
{
    ...
    fn invalid_token_identifier(&self) -> Option<RewaOrDcdtTokenIdentifier> {
    ...
    fn deploy_token_callback(
        ...
        match result {
            ...
            ManagedAsyncCallResult::Err(_) => {
                ...
                // Leave issue cost rewa payment in contract for use when retrying deployInterchainToken
            }
        }
    }
