  ...
  render() {
    ...
    return (
      <div class={this.transactionClass} key={this.hash} data-testid={DataTestIdsEnum.transactionDetailsToastBody}>
        ...
        <drt-explorer-link iconClass="transaction-details-list-item-explorer-link-icon" link={this.link} />
        <drt-copy-button iconClass="transaction-details-list-item-copy-button-icon" text={this.hash} />
      </div>
    );
  }
}
