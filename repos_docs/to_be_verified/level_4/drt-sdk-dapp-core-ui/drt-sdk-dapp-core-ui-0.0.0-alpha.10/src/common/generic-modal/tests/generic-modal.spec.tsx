...
describe('GenericModal Component', () => {
  it('should render with required props', async () => {
    const page = await newSpecPage({
      ...
      template: () => <drt-generic-modal modalTitle="Test Modal" body={<div>Modal Content</div>}></drt-generic-modal>,
    });
  ...
  it('should render with subtitle when modalSubtitle is provided', async () => {
    const page = await newSpecPage({
      components: [GenericModal],
      template: () => <drt-generic-modal modalTitle="Test Modal" modalSubtitle="Modal Subtitle" body={<div>Modal Content</div>}></drt-generic-modal>,
    });
