...
describe("test network providers on devnet: Proxy and API", function () {
    ...
    let apiProvider: INetworkProvider = new ApiNetworkProvider("https://devnet-api.dharitri.org", { timeout: 10000, clientName: 'test' });
    let proxyProvider: INetworkProvider = new ProxyNetworkProvider("https://devnet-gateway.dharitri.org", { timeout: 10000, clientName: 'test' });
    ...
    it("should add userAgent unknown for clientName when no clientName passed", async function () {
        ...
        let localProxyProvider: any = new ProxyNetworkProvider("https://devnet-gateway.dharitri.org", { timeout: 10000 });
    ...
    it("should set userAgent with specified clientName ", async function () {
        ...
        let localApiProvider: any = new ApiNetworkProvider("https://devnet-api.dharitri.org", { timeout: 10000, clientName: 'test' });
        let localProxyProvider: any = new ProxyNetworkProvider("https://devnet-gateway.dharitri.org", { timeout: 10000, clientName: 'test' });
    ...
    it("should keep the set userAgent and add the sdk to it", async function () {
        ...
        let localApiProvider: any = new ApiNetworkProvider("https://devnet-api.dharitri.org", { timeout: 10000, headers: new AxiosHeaders({ "User-Agent": "Client-info" }), clientName: 'test' });
        let localProxyProvider: any = new ProxyNetworkProvider("https://devnet-gateway.dharitri.org", { timeout: 10000, headers: new AxiosHeaders({ "User-Agent": "Client-info" }), clientName: 'test' });
    ...
    it("should have same response for getTransaction() (relayed V3)", async function () {
        ...
        // Transaction was sent using drtpy, as follows:
        // drtpy tx new --pem=~/dharitri-sdk/testwallets/latest/users/alice.pem --receiver=drt1spyavw0956vq68xj8y4tenjpq2wd5a9p2c6j8gsz7ztyrnpxrruqlqde3c --value=1000000000000000000 --gas-limit=50000 --recall-nonce --relayer=drt1r69gk66fmedhhcg24g2c5kn2f2a5k4kvpr6jfw67dn2lyydd8cfsncd6w8 --inner-transactions-outfile=inner.json --proxy=https://devnet-gateway.dharitri.org
        // drtpy tx new --pem=~/dharitri-sdk/testwallets/latest/users/grace.pem --receiver=drt1r69gk66fmedhhcg24g2c5kn2f2a5k4kvpr6jfw67dn2lyydd8cfsncd6w8 --gas-limit=100000 --recall-nonce --chain=D --inner-transactions=inner.json --proxy=https://devnet-gateway.dharitri.org --send
        ...
        assert.deepEqual(proxyResponse.innerTransactions, [
            {
                ...
                options: 0,
                relayer: "drt1r69gk66fmedhhcg24g2c5kn2f2a5k4kvpr6jfw67dn2lyydd8cfsncd6w8",
            },
        ]);
    ...
    it("should have same response for queryContract()", async function () {
        ...
        let query = new MockQuery({
            address: new Address("drt1qqqqqqqqqqqqqpgqfzydqmdw7m2vazsp6u5p95yxz76t2p9rd8ssj7kxgw"),
            func: "getSum"
        });
    ...
    it("should send `TransactionNext` (as relayed V3)", async function () {
        ...
        // Transaction was created using drtpy, as follows:
        // drtpy tx new --pem=~/dharitri-sdk/testwallets/latest/users/alice.pem --receiver=drt1spyavw0956vq68xj8y4tenjpq2wd5a9p2c6j8gsz7ztyrnpxrruqlqde3c --value=1000000000000000000 --gas-limit=50000 --nonce=7 --chain=D --relayer=drt1r69gk66fmedhhcg24g2c5kn2f2a5k4kvpr6jfw67dn2lyydd8cfsncd6w8 --inner-transactions-outfile=inner.json
        // drtpy tx new --pem=~/dharitri-sdk/testwallets/latest/users/grace.pem --receiver=drt1r69gk66fmedhhcg24g2c5kn2f2a5k4kvpr6jfw67dn2lyydd8cfsncd6w8 --gas-limit=100000 --nonce=42 --chain=D --inner-transactions=inner.json

        const transactionNext: ITransactionNext = {
            nonce: BigInt(42),
            value: BigInt(0),
            receiver: "drt1r69gk66fmedhhcg24g2c5kn2f2a5k4kvpr6jfw67dn2lyydd8cfsncd6w8",
            sender: "drt1r69gk66fmedhhcg24g2c5kn2f2a5k4kvpr6jfw67dn2lyydd8cfsncd6w8",
            data: new Uint8Array(),
            gasPrice: BigInt(1000000000),
