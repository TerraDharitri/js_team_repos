...
describe("test native serializer", () => {
    it("should perform type inference", async () => {
        ...
        const p0 = 42;
        const p1 = [new Address("drt1n2nkf0sfmst3z38p0sklz0xntprkr9hjr7rttewj3l9uhu629fpsfazg6k"), new Address("drt1kgxjlszkqcvccecuvl5r64c7cju7jqwp5kh22w4e6crf827peljqcvleft")];
    ...
    it("should perform type inference (enums)", async () => {
        ...
        const p2 = { name: 'Something', fields: { 0: 'drt1n2nkf0sfmst3z38p0sklz0xntprkr9hjr7rttewj3l9uhu629fpsfazg6k' } };
        ...
        assert.deepEqual(typedValues[2].valueOf(), { name: 'Something', fields: [new Address('drt1n2nkf0sfmst3z38p0sklz0xntprkr9hjr7rttewj3l9uhu629fpsfazg6k')] });
