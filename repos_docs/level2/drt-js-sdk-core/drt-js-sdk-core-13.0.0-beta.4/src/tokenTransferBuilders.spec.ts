...
describe("test token transfer builders", () => {
    ...
    it("should work with DCDTNFT transfers (NFT)", () => {
        ...
        assert.equal(
            payload.toString(),
            "DCDTNFTTransfer@4452544a532d333866323439@01@01@3ddf173c9e02c0e58fb1e552f473d98da6a4c3f23c7e034c912ee98a8dddce17",
        );
    });
    ...
    it("should work with Multi DCDTNFT transfers", () => {
        ...
        assert.equal(
            payload.toString(),
            "MultiDCDTNFTTransfer@c782420144e8296f757328b409d01633bf8d09d8ab11ee70d32c204f6589bd24@02@4452544a532d333866323439@01@01@4241522d633830643239@@8ac7230489e80000",
        );
    });
});
