...
describe("test abi registry", () => {
    ...
    it("binary codec correctly decodes perform action result", async () => {
        ...
        assert.deepEqual(
            ...
            `{"name":"SendTransferExecute","fields":[{"to":{"bech32":"drt13rrn3fwjds8r5260n6q3pd2qa6wqkudrhczh26d957c0edyzerms238v4e","pubkey":"88c738a5d26c0e3a2b4f9e8110b540ee9c0b71a3be057569a5a7b0fcb482c8f7"},"rewa_amount":"500000000000000000","endpoint_name":{"type":"Buffer","data":[104,101,108,108,111,32,119,111,114,108,100]},"arguments":[]}]}`
        );
    ...
    it("should load ABI when custom types are out of order (a)", async () => {
        ...
        assert.deepEqual(registry.getStruct("DcdtTokenTransfer").getNamesOfDependencies(), ["DcdtTokenType", "TokenIdentifier", "u64", "BigUint"]);
