...
describe("test transaction", function () {
    ...
    it("should send transactions", async function () {
        ...
        let transactionOne = new Transaction({
            ...
            value: TokenPayment.rewaFromAmount(42),
        ...
        let transactionTwo = new Transaction({
            sender: alice.address,
            receiver: bob.address,
            value: TokenPayment.rewaFromAmount(43),
            gasLimit: network.MinGasLimit,
            chainID: network.ChainID
        });
        ...
        assert.deepEqual(TokenPayment.rewaFromAmount(85).valueOf(), newBalanceOfBob.minus(initialBalanceOfBob));
    });
    ...
    it("should simulate transactions", async function () {
        ...
        let transactionOne = new Transaction({
            ...
            value: TokenPayment.rewaFromAmount(1000),
            chainID: network.ChainID
        });
        ...
        let transactionTwo = new Transaction({
            ...
            gasLimit: 70000,
            receiver: alice.address,
            value: TokenPayment.rewaFromAmount(1000000),
            chainID: network.ChainID
        });
