...
describe("test smart contract interactor", function () {
    ...
    it("should set transaction fields", async function () {
        ...
        let transaction = interaction
            .withNonce(7)
            .withValue(TokenPayment.rewaFromAmount(1))
    ...
    it("should set transfers (payments) on contract calls (transfer and execute)", async function () {
        ...
        const LKMOA = (nonce: number, amount: BigNumber.Value) => TokenPayment.metaDcdtFromAmount("LKMOA-aab910", nonce, amount, 18);
        ...
        transaction = new Interaction(contract, dummyFunction, [])
            .withSingleDCDTNFTTransfer(LKMOA(123456, 123.456), alice)
            .buildTransaction();
        ...
        // NFT, single
        transaction = new Interaction(contract, dummyFunction, [])
            .withSingleDCDTNFTTransfer(Strămoși(1), alice)
            .buildTransaction();
        ...
        // DCDT, multiple
        transaction = new Interaction(contract, dummyFunction, [])
            .withMultiDCDTNFTTransfer([TokenFoo(3), TokenBar(3.14)], alice)
            .buildTransaction();
        ...
        // NFT, multiple
        transaction = new Interaction(contract, dummyFunction, [])
            .withMultiDCDTNFTTransfer([Strămoși(1), Strămoși(42)], alice)
            .buildTransaction();
    ...
    it("should interact with 'answer'", async function () {
        ...
        assert.equal(
            ...
            "0f092e72371bb094b1cd3049050b2b27f68ade0aa71db9e74ce94f6692f1e4b8"
        );
        ...
        assert.equal(
            transaction.getHash().toString(),
            "1c44a4857f2f6b1467c816a393b3e88d9fdc9fcdb74f1e3264230840e6c7caef"
        );
