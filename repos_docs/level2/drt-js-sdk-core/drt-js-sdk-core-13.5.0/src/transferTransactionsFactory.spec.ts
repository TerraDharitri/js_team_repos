...
describe("test transaction factory", () => {
    ...
    it("should create REWA transfers", () => {
        ...
        assert.equal(
            ...
            "drt1n2nkf0sfmst3z38p0sklz0xntprkr9hjr7rttewj3l9uhu629fpsfazg6k",
        );
    ...
    it("should create DCDTNFT transfers", () => {
        ...
        assert.equal(
            ...
            "DCDTNFTTransfer@544553542d333866323439@01@01@3ddf173c9e02c0e58fb1e552f473d98da6a4c3f23c7e034c912ee98a8dddce17",
        );
        assert.equal(transaction.getChainID(), "D");
    });
    ...
    it("should create Multi DCDTNFT transfers", () => {
        ...
        assert.equal(
            transaction.getData().toString(),
            "MultiDCDTNFTTransfer@c782420144e8296f757328b409d01633bf8d09d8ab11ee70d32c204f6589bd24@02@464f4f2d333866323439@01@01@4241522d633830643239@@8ac7230489e80000",
        );
        assert.equal(transaction.getChainID(), "D");
    });
});
