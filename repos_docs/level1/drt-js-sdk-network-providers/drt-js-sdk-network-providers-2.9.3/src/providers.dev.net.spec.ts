...
describe("test network providers on devnet: Proxy and API", function () {
    ...
    it("should add userAgent unknown for clientName when no clientName passed", async function () {
        const expectedApiUserAgent = "terradharitri-sdk/api/unknown"
        const expectedProxyUserAgent = "terradharitri-sdk/proxy/unknown"
    ...
    it("should set userAgent with specified clientName ", async function () {
        const expectedApiUserAgent = "terradharitri-sdk/api/test"
        const expectedProxyUserAgent = "terradharitri-sdk/proxy/test"
    ...
    it("should keep the set userAgent and add the sdk to it", async function () {
        const expectedApiUserAgent = "Client-info terradharitri-sdk/api/test"
        const expectedProxyUserAgent = "Client-info terradharitri-sdk/proxy/test"
